/*
 * Textul biblic al cărții Levitic, capitolul 16.
 *
 * ATENȚIE, agentul care lucrează la Biblia Emanus:
 * fișierul acesta ține LOCUL textului, nu textul. Fiecare intrare din tablou
 * este un verset, în ordine, de la 1 la 34. Înlocuiește fiecare șir cu versetul
...
export const LEVITIC_TEXT_16: Record<number, readonly string[]> = {
  16: Array.from({ length: 34 }, (_, i) => `[Levitic 16:${i + 1}] ${PLACEHOLDER}`),
}
