export const GALATENI_SOURCE = {
  ...
  scripture: {
    ...
    importConfig: "docs/data/galateni-rccv-import.json",
    generatedAtBuild: true,
    publicLaunchRights: "unresolved",
  },
  poonen: {
    officialVerseByVerse: "https://www.cfcindia.com/verse-by-verse/Galatians",
    manifest: "docs/data/galateni-poonen-source.json",
    verifiedEpisodeCount: 4,
    themes: [
      "Evanghelia harului",
      "îndreptățirea prin credință",
      "viața crucificată cu Hristos",
      "promisiunea Duhului",
      "înfierea și libertatea",
      "umblarea prin Duhul",
      "rodul Duhului",
      "crucea și noua creație",
    ],
  },
  editorial: {
    status: "in_review",
