...
const RUT_EXPLANATION_SOURCE = "Zac Poonen — Through The Bible: Judges & Ruth"
...
function normalizeUnit(unit: BibleUnit): BibleUnit {
  return {
    ...
    explanationSource: unit.explanationSource ?? RUT_EXPLANATION_SOURCE,
    wordSource:
...
export function rutChapter(input: {
  number: number
  title: string
  summary: string
