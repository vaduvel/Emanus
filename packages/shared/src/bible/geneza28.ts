...
export const GENEZA_28: BibleChapter = {
  ...
  historicalContext:
    "Luz era o asezare veche pe drumul care leaga miazanoapte de miazazi, la vreo optzeci de kilometri de Beer-Seba, cale de doua-trei zile de mers pe jos. In religiile vechi ale tinutului, zeii erau adesea legati de locuri si sanctuare; de aceea fagaduinta ca Domnul il pazeste pe Iacov oriunde merge este izbitoare. Unii cercetatori compara scara din vis cu templele in trepte ale lumii vechi, dar Geneza nu face ea insasi aceasta identificare. Stalpul de piatra uns cu untdelemn era chipul obisnuit de a insemna un loc ca fiind sfant.",
  status: "in_review",
  units: [
    {
      id: "geneza-28-1-5",
      ...
      words: [
        {
          ...
          language: "ebraica",
          meaning:
            "Dumnezeul cel Atotputernic, redarea traditionala a numelui El Șadai; etimologia exacta a numelui este discutata."
        }
      ],
      crossRefs: [
        "Geneza 17:1",
    ...
    },
    {
      ...
      text:
        "Iacov s-a trezit din somn și a zis: „Cu adevărat, Domnul este în locul acesta, și eu n-am știut.” I-a fost frică și a zis: „Cât de înfricoșat este locul acesta! Aici este casa lui Dumnezeu, aici este poarta cerurilor!” Şi Iacov s-a sculat dis-de-dimineață, a luat piatra pe care o pusese căpătâi, a pus-o ca stâlp de aducere aminte și a turnat untdelemn pe vârful ei. A dat locului acestuia numele Betel; dar mai înainte cetatea se chema Luz.",
      teaching:
