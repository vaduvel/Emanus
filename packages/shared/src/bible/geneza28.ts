...
export const GENEZA_28: BibleChapter = {
  ...
  units: [
    ...
    },
    {
      ...
      text:
        "Iacov a făcut o juruinţă, şi a zis: „Dacă va fi Dumnezeu cu mine şi mă va păzi în timpul călătoriei pe care o fac, dacă-mi va da pîne să mănînc şi haine să mă îmbrac, şi dacă mă voi întoarce în pace în casa tatălui meu, atunci Domnul va fi Dumnezeul meu; piatra aceasta, pe care am pus-o ca stîlp de aducere aminte, va fi casa lui Dumnezeu, şi Îţi voi da a zecea parte din tot ce-mi vei da.\" Wordproject® is a registered name of the International Biblical Association, a non-profit organization registered in Macau, China. Contact | Disclaimer | Statement of Faith | Mission |",
      teaching:
