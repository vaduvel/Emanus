...
export const NT_BOOK_18: BibleBook = {
  "id": "filimon",
  "name": "Filimon",
  "testament": "nt",
  "order": 57,
  "blurb": "Pavel îi scrie lui Filimon pentru Onisim, omul care plecase de la el și care acum se întorcea schimbat de Evanghelie. Apostolul nu-și folosește autoritatea pentru a constrânge, ci mijlocește cu dragoste, asumându-și chiar datoria celui vinovat.",
  "chapters": [
    {
      "id": "filimon-1",
      "bookId": "filimon",
      "number": 1,
      "title": "Filimon 1 — Primește-l ca pe mine însumi",
      "summary": "Pavel îi scrie lui Filimon pentru Onisim, omul care plecase de la el și care acum se întorcea schimbat de Evanghelie. Apostolul nu-și folosește autoritatea pentru a constrânge, ci mijlocește cu dragoste, asumându-și chiar datoria celui vinovat.",
      "literaryContext": "Filimon este o scrisoare personală, dar adresată și comunității care se aduna în casa lui. Ea stă aproape de Coloseni: Onisim este pomenit acolo ca frate credincios și preaiubit, iar Arhip primește o chemare directă la slujire. Scrisoarea arată Evanghelia lucrând într-o relație concretă, unde există vină, datorie, autoritate și nevoia unei primiri adevărate.",
      "historicalContext": "Explicația subliniază că Pavel nu transformă scrisoarea într-un manifest politic; el lucrează în primul rând pentru împăcarea oamenilor și zidirea bisericii. Totuși, îi cere lui Filimon să nu-l privească pe Onisim doar prin vechea lui poziție, ci ca pe un frate preaiubit în Domnul.",
      "units": [
        {
          "id": "filimon-1-1-3",
          "ref": "Filimon 1:1-3",
        ...
        },
        {
          ...
          "forYourHeart": "Cine este mai întărit fiindcă te cunoaște? Cere-I lui Dumnezeu ca dragostea ta să nu rămână o intenție, ci să învioreze concret inima cuiva."
        },
        {
          "id": "filimon-1-8-16",
          "ref": "Filimon 1:8-16",
        ...
        },
        {
          ...
          "forYourHeart": "Isus nu te-a adus înaintea Tatălui spunând că datoria ta nu există. A luat-o asupra Lui. Primește această pace și învață să porți și tu, cu înțelepciune, povara altuia."
        },
        {
          "id": "filimon-1-23-25",
          "ref": "Filimon 1:23-25",
          ...
          "forYourHeart": "Nu toate împrejurările se schimbă imediat, dar relația cu un frate poate fi schimbată de har chiar astăzi. Fă pasul de adevăr și pace pe care îl cere Domnul."
        }
      ],
