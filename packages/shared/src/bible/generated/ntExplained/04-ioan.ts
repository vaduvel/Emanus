...
export const NT_BOOK_04: BibleBook = {
  ...
  "chapters": [
    ...
    },
    {
      ...
      "summary": "Capitolul arata necredinta fratilor lui Isus, învățătură Lui în Templu la Praznicul Corturilor, chemarea la apa vie și dezbinarea pe care Persoana Lui o aduce în norod și intre mai-marii poporului.",
      "literaryContext": "Dupa cernerea din Ioan 6, capitolul 7 ne duce la Praznicul Corturilor, unde tensiunea fata de Domnul Isus creste și mai mult. Capitolul merge în valuri de apropiere și impotrivire: mai întâi neincrederea fratilor Lui, apoi învățătură din Templu, chemarea din ziua cea mare a praznicului și, la urma, dezbinarea starnita de cuvântul și Persoana Lui. Ioan ne arata iarasi ca nimeni nu poate rămâne neutru fata de Hristos.",
