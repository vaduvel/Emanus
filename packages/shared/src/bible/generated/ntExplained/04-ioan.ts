...
export const NT_BOOK_04: BibleBook = {
  ...
  "chapters": [
    ...
    },
    {
      ...
      "units": [
        ...
        },
        {
          ...
          "forYourHeart": "Dacă Fiul are viață în Sine, atunci credința ta nu se sprijină pe taria ta de a te ține în viață, ci pe El. Și dacă El te-a trecut din moarte la viață, poti merge chiar și prin umbre grele fără sa te intorci iarasi la frica de osanda."
        },
        {
          "id": "ioan-5-31-47",
          "ref": "Ioan 5:31-47",
    ...
    },
    {
      ...
      "summary": "Domnul Isus Se descoperă ca Usa oilor și Pastorul cel bun, vorbește despre oile care-I cunosc glasul, despre viața dată cu belșug și despre unitatea Lui cu Tatăl, starnind iarasi dezbinare și împotrivire.",
