...
export const NT_BOOK_13: BibleBook = {
  "id": "1-tesaloniceni",
  "name": "1 Tesaloniceni",
  "testament": "nt",
  "order": 52,
      ...
      "units": [
        {
          ...
          "text": "Pentru voi înșivă știți, fraților, vizita noastră la voi nu a fost zadarnică, Dar după ce am suferit înainte și am fost tratați cu rușine, după cum știți, la Filipi, am devenit curajoși în Dumnezeul nostru să vă spunem vestea bună a lui Dumnezeu în multe conflicte. Căci îndemnul nostru nu este nici de rătăcire, nici de necurăție, nici de înșelăciune. Dar așa cum am fost aprobați de Dumnezeu să ni se încredize Vestea Bună, tot așa vorbim — nu ca oameni plăcuți, ci ca Dumnezeu, care ne pune la încercare inimile.",
        ...
        },
        {
          ...
          "teaching": "Apostolii au muncit zi și noapte ca să nu fie o povară, deși slujitorii Evangheliei pot primi sprijin legitim. Pavel amintește conduita lor sfântă, dreaptă și fără reproș, nu ca laudă de sine, ci ca dovadă că mesajul era susținut de viață.\n\nCa un tată, el a îndemnat, a încurajat și a chemat pe fiecare la o umblare vrednică de Dumnezeu. Îndemnul părintesc biblic formează maturitate și responsabilitate; nu cere supunere oarbă și nu transformă munca într-o justificare pentru exploatare, epuizare sau dispreț față de cei bolnavi ori vulnerabili.",
          "crossRefs": [
            "Faptele 20:33-35",
            "1 Corinteni 9:7-14",
            "Efeseni 4:1"
    ...
    },
    {
      ...
      "units": [
        ...
        },
        {
          ...
          "text": "Dar noi nu vrem ca voi să fiți neștiutori, fraților, cu privire la cei care au adormit, ca să nu vă întristați ca ceilalți, care nu au nici o speranță. Căci dacă credem că Isus a murit și a înviat din nou, tot așa Dumnezeu îi va aduce cu noi pe cei care au adormit în Isus. Pentru aceasta vă spunem prin cuvântul Domnului, că noi cei vii, care am rămas până la venirea Domnului, nu vom preceda nicidecum pe cei adormi. Căci Domnul însuși va coborî din cer cu un strigăt, cu glasul arhanghelului și cu trîmbița lui Dumnezeu. Cei morți în Hristos vor învia primii, Atunci noi, cei vii, care am mai rămas, vom fi prinși împreună cu ei în nori, ca să-L întâlnim pe Domnul în aer, așa că vom fi cu Domnul pentru totdeauna. Așadar, mângâieți-vă unii pe alții cu aceste cuvinte.",
          "teaching": "Pavel nu le cere credincioșilor să nu plângă, ci să nu se întristeze ca oamenii fără speranță. Moartea doare, iar lacrimile nu sunt necredință. Nădejdea se sprijină pe faptul că Isus a murit și a înviat, iar Dumnezeu îi va aduce cu El pe cei care au adormit în Hristos.\n\nCei vii nu îi vor preceda pe cei morți. Domnul va coborî, morții în Hristos vor învia, iar credincioșii vor fi adunați pentru a fi pentru totdeauna cu El. Centrul promisiunii nu este curiozitatea despre cronologie, ci prezența veșnică a lui Isus și mângâierea reciprocă.\n\nTextul nu permite stabilirea datelor, alimentarea panicii sau neglijarea vieții prezente. În doliu sever, depresie ori gânduri de autovătămare, durerea nu trebuie purtată singur; ajutorul medical și psihologic, sprijinul apropiaților și protecția imediată sunt compatibile cu credința.",
          "crossRefs": [
            "Ioan 11:25-26",
    ...
    },
    {
      ...
      "units": [
        ...
        },
        {
          ...
          "text": "Bucurați-vă întotdeauna. Rugați-vă fără încetare. În toate, mulțumiți, căci aceasta este voia lui Dumnezeu în Hristos Isus față de voi.",
        ...
        },
        {
          ...
          "text": "Fie ca Dumnezeul păcii să vă sfințească întru totul; tot spiritul, sufletul și trupul vostru să fie păzit fără prihană la venirea Domnului nostru Isus Hristos. Cel care te cheamă este credincios, care o va face și el.",
        ...
        },
        {
          ...
          "text": "Fraților, rugați-vă pentru noi. Salută-i pe toți frații cu un sărut sfânt. Îți poruncesc solemn prin Domnul ca această scrisoare să fie citită tuturor fraților sfinți. Harul Domnului nostru Isus Hristos să fie cu voi. Amin.",
