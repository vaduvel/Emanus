...
// Sursă: Biblia Emanus NEH, 13 capitole; nu edita manual.

export const NEEMIA_TEXT: Readonly<Record<number, readonly string[]>> = {
  1: [
    "Istorisirea lui Neemia, fiul lui Hacalia. În luna Chișleu, în al douăzecilea an, pe când eram în capitala Susa,",
    "a venit Hanani, unul din frații mei, și câțiva oameni din Iuda. I-am întrebat despre iudeii scăpați care mai rămăseseră din robie și despre Ierusalim.",
    ...
    "Te-am supărat și n-am păzit poruncile Tale, legile și orânduirile pe care le-ai dat robului Tău Moise.",
    "Adu-Ți aminte de cuvintele acestea pe care le-ai dat robului Tău Moise să le spună: „Când veți păcătui, vă voi risipi printre popoare;”",
    ...
    "Ei sunt robii Tăi și poporul Tău pe care l-ai răscumpărat prin puterea Ta cea mare și prin mâna Ta cea tare.",
  ...
  2: [
    ...
    "Împăratul, lângă care ședea și împărăteasa, mi-a zis atunci: „Cât va ține călătoria ta și când te vei întoarce?”",
    ...
    "M-am dus la dregătorii de dincolo de Râu și le-am dat scrisorile împăratului, care pusese să mă însoțească niște mai mari ai oștii și niște călăreți.",
    "Sanbalat, horonitul, și Tobia, slujitorul amonit, când au auzit lucrul acesta, nu le-a plăcut deloc că venea un om să caute binele copiilor lui Israel.",
  ...
  3: [
    ...
    "Fiii lui Senaa au zidit poarta peștilor. Au acoperit-o cu scânduri și i-au pus ușile, încuietorile și zăvoarele.",
    ...
    "Alături de ei au lucrat Melatia, gabaonitul, Iadon, meronotitul, și oamenii din Gabaon și Mițpa, până la scaunul dregătorului de dincoace de râul Eufrat;",
    "alături de ei a lucrat Uziel, fiul lui Harhaia, dintre argintari, și alături de el a lucrat Hanania, dintre făcătorii de mir. Au întărit Ierusalimul până la zidul cel lat.",
    ...
    "Hanun și locuitorii Zanoahului au dres poarta văii. Au zidit-o și i-au pus ușile, încuietorile și zăvoarele. Ei au făcut o mie de coți de zid până la poarta gunoiului.",
    ...
    "Șalum, fiul lui Col-Hoze, mai marele peste ținutul Mițpa, a dres poarta izvorului. A zidit-o, a acoperit-o cu scânduri și i-a pus ușile, încuietorile și zăvoarele. A făcut zidul iazului Siloe lângă grădina împăratului, până la treptele care coboară din cetatea lui David.",
    ...
    "După el, Baruc, fiul lui Zabai, a dres cu râvnă o altă parte, de la unghi până la poarta casei marelui preot, Eliașib.",
    ...
    "După el, Malchia, dintre argintari, a lucrat până la casele slujitorilor Templului și negustorilor, în dreptul porții Mifcad și până la odaia de sus din colț.",
  ...
  4: [
    ...
    "și a zis înaintea fraților săi și înaintea ostașilor Samariei: „La ce lucrează acești iudei neputincioși? Oare vor fi lăsați să lucreze? Oare vor jertfi? Oare vor isprăvi? Oare vor da ei viață unor pietre înmormântate sub mormane de praf și arse de foc?”",
    "Tobia, amonitul, era lângă el și a zis: „Să zidească numai! Dacă se va sui o vulpe, le va dărâma zidul lor de piatră.”",
    "„Ascultă, Dumnezeul nostru, cum suntem batjocoriți! Fă să cadă ocările lor asupra capului lor și dă-i pradă pe un pământ unde să fie robi.”",
    ...
    "Dar Sanbalat, Tobia, arabii, amoniții și asdodienii s-au supărat foarte tare când au auzit că dregerea zidurilor înainta și că spărturile începeau să se astupe.",
    ...
    "Și vrăjmașii noștri ziceau: „Nu vor ști și nu vor vedea nimic până vom ajunge în mijlocul lor; îi vom ucide și vom face astfel să înceteze lucrarea.”",
    "Și iudeii care locuiau lângă ei, au venit de zece ori și ne-au înștiințat despre toate locurile pe unde veneau la noi.",
    ...
    "Așa făceam lucrarea: jumătate din noi stând cu sulița în mână din zorii zilei până la ivirea stelelor.",
    "În același timp, am mai zis poporului: „Fiecare să petreacă noaptea în Ierusalim cu slujitorul lui; noaptea să facem de strajă, iar ziua să lucrăm.”",
  ...
  5: [
    ...
    "Ei au răspuns: „Le vom da înapoi și nu le vom cere nimic, vom face cum ai zis.”",
    ...
    "Aveam la masă o sută cincizeci de oameni, iudei și dregători, afară de cei ce veneau la noi din neamurile dimprejur.",
    "Mi se pregătea în fiecare zi un bou, șase berbeci aleși și păsări, și la fiecare zece zile se pregătea din belșug tot vinul care era de trebuință. Cu toate acestea, n-am cerut veniturile cuvenite dregătorului, pentru că lucrările apăsau greu asupra poporului acestuia.",
  ...
  6: [
    ...
    "Sanbalat mi-a trimis solia aceasta a cincea oară prin slujitorul său, care ținea în mână o scrisoare deschisă.",
    ...
    "„și că ai pus chiar proroci ca să te numească la Ierusalim împărat al lui Iuda. Și acum lucrurile acestea vor ajunge la cunoștința împăratului. Vino, dar, și să ne sfătuim împreună.”",
    "Am trimis următorul răspuns lui Sanbalat: „Ce ai spus tu în scrisoare nu este; tu de la tine le născocești!”",
    ...
    "Și am cunoscut că nu Dumnezeu îl trimitea. Ci a prorocit așa pentru mine, fiindcă Sanbalat și Tobia îi dăduseră argint.",
    ...
    "În vremea aceea erau unii fruntași din Iudeea, care trimiteau deseori scrisori lui Tobia și primeau și ei scrisori de la el.",
    "Căci mulți din Iuda erau legați cu el prin jurământ, pentru că era ginerele lui Șecania, fiul lui Arah, și fiul său Iohanan luase pe fata lui Meșulam, fiul lui Berechia.",
  ...
  7: [
    ...
    "Am poruncit fratelui meu Hanani și lui Hanania, căpetenia cetățuii Ierusalimului, om care întrecea pe mulți prin credincioșia și prin frica lui de Dumnezeu,",
    ...
    "Leviți: fiii lui Iosua și lui Cadmiel, din fiii lui Hodva, șaptezeci și patru.",
  ...
  8: [
    ...
    "Ezra a binecuvântat pe DOMNUL Dumnezeul cel mare, și tot poporul a răspuns ridicând mâinile: „Amin! Amin!”",
    ...
    "Ei le-au zis: „Duceți-vă de mâncați cărnuri grase și beți băuturi dulci și trimiteți câte o parte și celor ce n-au nimic pregătit, căci ziua aceasta este închinată DOMNULUI nostru; nu vă mâhniți, căci bucuria DOMNULUI va fi tăria voastră.”",
    ...
    "Au citit în cartea Legii lui Dumnezeu în fiecare zi, din cea dintâi zi până la cea din urmă. Au prăznuit sărbătoarea șapte zile și a fost o adunare de sărbătoare în ziua a opta, cum este poruncit.",
  ],
  9: [
    "În a douăzeci și patra zi a aceleiași luni, copiii lui Israel s-au adunat, îmbrăcați în saci și presărați cu țărână, pentru ținerea unui post.",
    ...
    "După ce au șezut jos, au citit în cartea Legii DOMNULUI Dumnezeului lor a patra parte din zi; și altă a patra parte din zi și-au mărturisit păcatele și s-au închinat înaintea DOMNULUI Dumnezeului lor.",
    ...
    "Tu, DOAMNE, numai Tu ai făcut cerurile, cerurile cerurilor și toată oștirea lor, și pământul cu tot ce este pe el, mările cu tot ce cuprind ele. Tu dai viață tuturor acestor lucruri, și oștirea cerurilor se închină înaintea Ta.",
    "Tu, DOAMNE Dumnezeule, ai ales pe Avram, l-ai scos din Ur din Haldeea și i-ai pus numele Avraam.",
    "Tu ai găsit inima lui credincioasă înaintea Ta, ai făcut legământ cu el și ai făgăduit că vei da seminței lui țara canaaniților, hetiților, amoriților, fereziților, iebusiților și ghirgasiților. Și Ți-ai ținut cuvântul, căci ești drept.",
    ...
    "nici chiar atunci când și-au făcut un vițel turnat și au zis: „Iată Dumnezeul tău care te-a scos din Egipt!”",
    "În îndurarea Ta fără margini, nu i-ai părăsit în pustiu, și stâlpul de nor n-a încetat să-i călăuzească ziua pe drum, nici stâlpul de foc să le lumineze noaptea drumul pe care aveau să-l urmeze.",
    ...
    "Patruzeci de ani ai avut grijă să-i hrănești în pustiu, și n-au dus lipsă de nimic, hainele nu li s-au învechit, și picioarele nu li s-au umflat.",
    "Le-ai dat în mână împărății și popoare ale căror ținuturi le-ai împărțit între ei, și au stăpânit țara lui Sihon, împăratul Hesbonului, și țara lui Og, împăratul Basanului.",
    "Le-ai înmulțit fiii ca stelele cerurilor și i-ai adus în țara despre care spuseseși părinților lor că au s-o ia în stăpânire.",
    ...
    "Totuși ei s-au răsculat și s-au răzvrătit împotriva Ta. Au aruncat Legea Ta la spatele lor, au ucis pe prorocii Tăi, care-i rugau fierbinte să se întoarcă la Tine, și s-au dedat la mari ocări față de Tine.",
    "Atunci i-ai lăsat în mâinile vrăjmașilor lor, care i-au apăsat. Dar, în vremea necazului lor, au strigat către Tine; și Tu i-ai auzit de la înălțimea cerurilor și, în îndurarea Ta cea mare, le-ai dat izbăvitori, care i-au scăpat din mâinile vrăjmașilor lor.",
    "Când au avut odihnă, au început iarăși să facă rău înaintea Ta. Atunci i-ai lăsat în mâinile vrăjmașilor lor, care i-au stăpânit. Dar din nou au strigat către Tine; și Tu i-ai auzit de la înălțimea cerurilor și, în marea Ta îndurare, i-ai izbăvit de mai multe ori.",
    ...
    "I-ai îngăduit astfel mulți ani, le-ai dat înștiințări prin Duhul Tău, prin proroci, și tot n-au luat aminte. Atunci i-ai dat în mâinile unor popoare străine.",
    ...
    "Împărații noștri, căpeteniile noastre, preoții noștri și părinții noștri n-au păzit Legea și n-au dat ascultare nici poruncilor, nici înștiințărilor pe care li le dădeai.",
    "Când erau stăpâni, în mijlocul multelor binefaceri pe care li le dădeai, în țara întinsă și roditoare pe care le-o dăduseși, nu Ți-au slujit și nu s-au abătut de la faptele lor rele.",
    "Și astăzi, iată-ne robi! Iată-ne robi pe pământul pe care l-ai dat părinților noștri pentru ca să se bucure de roadele și de bunurile lui!",
    "„El își înmulțește roadele pentru împărații cărora ne-ai supus din pricina păcatelor noastre; ei stăpânesc după plac asupra trupurilor noastre și asupra vitelor noastre, și suntem într-o mare strâmtorare!”",
  ...
  10: [
    ...
    "Ahia, Hanan, Anan,",
    "Maluc, Harim, Baana.",
    "Cealaltă parte a poporului, preoții, leviții, ușierii, cântăreții, slujitorii Templului și toți cei ce se despărțiseră de popoarele străine ca să urmeze Legea lui Dumnezeu, nevestele lor, fiii și fetele lor, toți cei ce aveau cunoștință și pricepere",
    ...
    "Am tras la sorți, preoți, leviți și popor, pentru lemnele care trebuiau aduse pe fiecare an ca dar la Casa Dumnezeului nostru, după casele noastre părintești, la vremuri hotărâte, ca să fie ars pe altarul DOMNULUI Dumnezeului nostru, cum este scris în Lege.",
  ...
  11: [
    ...
    "Seraia, fiul lui Hilchia, fiul lui Meșulam, fiul lui Țadoc, fiul Meraiot, fiul lui Ahitub, domnul Casei lui Dumnezeu,",
    ...
    "Cealaltă parte din Israel, din preoți, și din leviți s-au așezat în toate cetățile lui Iuda, fiecare în moșia lui.",
    ...
    "Cât despre sate și câmpiile lor, unii din fiii lui Iuda s-au așezat la Chiriat-Arba și în locurile care țin de el, la Dibon și în locurile care țin de el, Iecabțeel și în satele care țin de el,",
  ...
  12: [
    ...
    "Salu, Amoc, Hilchia, Iedaia. Aceștia au fost căpeteniile preoților și a fraților lor, pe vremea lui Iosua.",
    ...
    "La sfințirea zidurilor Ierusalimului au chemat pe leviți din toate locurile în care locuiau și i-au adus la Ierusalim, ca să prăznuiască sfințirea și sărbătoarea cu laude și cântări, în sunet de chimvale, lăute și harpe.",
    ...
    "Preoții și leviții s-au curățat și au curățat și pe popor, porțile și zidul.",
    ...
    "păzind tot ce privea slujba lui Dumnezeu și a curățărilor. Cântăreții și ușierii își împlineau și ei slujbele, după rânduiala lui David și a fiului său Solomon.",
  ...
  13: [
    ...
    "Când au auzit Legea, au deosebit din Israel pe toți străinii.",
    ...
    "Apoi am poruncit să se curețe odăile și am pus iarăși în ele uneltele Casei lui Dumnezeu, darurile de mâncare și tămâia.",
    ...
    "Am mustrat pe dregători și am zis: „Pentru ce a fost părăsită Casa lui Dumnezeu?”",
    "Atunci tot Iuda a adus în cămări zeciuiala din grâu, din must și din untdelemn.",
    "Am dat cămările în grija preotului Șelemia, cărturarului Țadoc și lui Pedaia, unul din leviți, și le-am adăugat și pe Hanan, fiul lui Zacur, fiul lui Matania, căci le mergea numele că sunt credincioși. Ei au fost însărcinați să facă împărțirile cuvenite fraților lor.",
    ...
    "Pe vremea aceasta am văzut în Iuda niște oameni călcând la teasc în ziua Sabatului, aducând snopi, încărcând măgarii cu vin, struguri și smochine, și cu tot felul de lucruri și aducându-le la Ierusalim în ziua Sabatului. Și i-am mustrat chiar în ziua când își vindeau mărfurile.",
    "Mai erau și niște tirieni, așezați în Ierusalim, care aduceau pește și tot felul de mărfuri și le vindeau fiilor lui Iuda în ziua Sabatului și în Ierusalim.",
    "Am mustrat pe mai marii lui Iuda și le-am zis: „Ce înseamnă această faptă rea pe care o faceți, pângărind ziua Sabatului?”",
    ...
    "Am poruncit și leviților să se curețe și să vină să păzească porțile, ca să sfințească ziua Sabatului. Adu-Ți aminte de mine, Dumnezeule, și pentru aceste lucruri și ocrotește-mă după marea Ta îndurare!",
    ...
    "I-am mustrat și i-am blestemat; am lovit pe unii din ei, le-am smuls părul și i-am pus să jure în Numele lui Dumnezeu, zicând: „Să nu vă dați fetele după fiii lor și să nu luați fetele lor de neveste nici pentru fiii voștri, nici pentru voi.”",
    ...
    "I-am curățat de orice străin și am pus rânduială în tot ce trebuiau să păzească preoții și leviții, fiecare în slujba lui,",
