...
export const AMOS_TEXT: Readonly<Record<number, readonly string[]>> = {
  1: [
    "Cuvintele lui Amos, unul din păstorii din Tecoa, vedeniile pe care le-a avut el despre Israel, pe vremea lui Ozia, împăratul lui Iuda, și pe vremea lui Ieroboam, fiul lui Ioas, împăratul lui Israel, cu doi ani înaintea cutremurului de pământ.",
    ...
    "Așa vorbește DOMNUL: „Pentru trei nelegiuiri ale Gazei, ba pentru patru, nu-Mi schimb hotărârea, pentru că au luat pe toți oamenii prinși de război și i-au dat Edomului:”",
    ...
    "Așa vorbește DOMNUL: „Pentru trei nelegiuiri ale Tirului, ba pentru patru, nu-Mi schimb hotărârea, pentru că au luat pe toți oamenii prinși de război și i-au dat Edomului, și nu s-au gândit la legământul frățesc.”",
  ...
  2: [
    "Așa vorbește DOMNUL: „Pentru trei nelegiuiri ale Moabului, ba pentru patru, nu-Mi schimb hotărârea, pentru că a ars, a ars până le-a făcut var, oasele împăratului Edomului,”",
    ...
    "Iată, vă voi stropși cum stropșește pământul carul încărcat cu snopi,",
  ...
  3: [
    ...
    "Nu, DOMNUL Dumnezeu nu face nimic fără să-Și descopere taina Sa slujitorilor Săi proroci.",
  ...
  4: [
    ...
    "Faceți să fumege jertfe de mulțumire făcute cu aluat! Trâmbițați-vă, vestiți-vă darurile de mâncare de bunăvoie! Căci așa vă place, copii ai lui Israel, zice DOMNUL Dumnezeu. –",
    ...
    "V-am nimicit ca pe Sodoma și Gomora, pe care le-a nimicit Dumnezeu; și ați fost ca un tăciune scos din foc. Cu toate acestea, tot nu v-ați întors la Mine, zice DOMNUL… –",
  ...
  5: [
    ...
    "Vai de cei care doresc ziua DOMNULUI! La ce vă va folosi ziua DOMNULUI? Ea va fi întuneric, nu lumină.",
  ...
  6: [
    ...
    "Aiurează în sunetul lăutei, se cred iscusiți ca David în instrumentele de muzică.",
    ...
    "Pot caii să alerge pe o stâncă? Sau poate cineva să are marea cu boii, de ați prefăcut judecata în otravă și rodul dreptății, în pelin?",
    "Vă bucurați de lucruri de nimic și ziceți: „Oare nu prin tăria noastră am câștigat noi putere?”",
    "„De aceea iată, voi ridica împotriva voastră, casa lui Israel, zice DOMNUL Dumnezeul oștirilor, un neam care vă va asupri de la intrarea Hamatului până la pârâul pustiului.”",
  ],
  7: [
    ...
    "Atunci DOMNUL S-a căit și de lucrul acesta: „Niciuna ca aceasta nu se va întâmpla, a zis DOMNUL Dumnezeu.”",
  ...
  9: [
    ...
    "Iată, DOMNUL Dumnezeu are ochii pironiți peste împărăția aceasta vinovată, ca s-o nimicesc de pe fața pământului; totuși nu voi nimici de tot casa lui Iacov, zice DOMNUL.",
    ...
    "Voi aduce înapoi pe prinșii de război ai poporului Meu, Israel; ei vor zidi iarăși cetățile pustiite și le vor locui, vor sădi vii și le vor bea vinul, vor face grădini și le vor mânca roadele.",
