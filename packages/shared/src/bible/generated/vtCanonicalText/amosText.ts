...
// Sursă de lucru: Text biblic provizoriu pentru lucru editorial — de înlocuit cu Biblia Emanus; AMO, 9 capitole; nu edita manual.
...
export const AMOS_TEXT: Readonly<Record<number, readonly string[]>> = {
  ...
  5: [
    ...
    "Vai de cei ce doresc „ziua DOMNULui”",
