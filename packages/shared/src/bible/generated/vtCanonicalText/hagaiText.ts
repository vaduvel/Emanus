...
// Sursă de lucru: Text biblic provizoriu pentru lucru editorial — de înlocuit cu Biblia Emanus; HAG, 2 capitole; nu edita manual.
...
export const HAGAI_TEXT: Readonly<Record<number, readonly string[]>> = {
  ...
  2: [
    "În a douăzeci și una zi a lunii a șaptea, cuvântul DOMNULui a vorbit prin prorocul Hagai astfel:",
    "„Vorbește lui Zorobabel, fiul lui Șealtiel, dregătorul lui Iuda, lui Iosua, fiul lui Ioțadac, marele preot, și rămășiței poporului și spune-le:”",
    "„Cine a mai rămas între voi din cei ce au văzut Casa aceasta în slava ei dintâi? Și cum o vedeți acum? Așa cum este, nu pare ea ca o nimica în ochii voștri?”",
    ...
    "„Așa vorbește DOMNUL oștirilor: „Pune preoților următoarea întrebare asupra Legii:””",
    ...
    "Atunci când veneau la o grămadă de douăzeci de măsuri, nu erau în ea decât zece; când veneau la teasc să scoată cinzeci de măsuri, nu erau în el decât douăzeci!",
    ...
    "Uitați-vă cu băgare de seamă la cele ce s-au petrecut până în ziua de azi, până în a douăzeci și patra zi a lunii a noua, din ziua când a fost întemeiat Templul DOMNULui, uitați-vă cu băgare de seamă la ele.",
    "„Mai era sămânță în grânare? Nici via, nici smochinul, nici rodiul și nici măslinul n-au mai adus nimic. Dar din ziua aceasta, Îmi voi da binecuvântarea Mea.”",
    "Cuvântul DOMNULui a vorbit a doua oară lui Hagai, în a douăzeci și patra zi a lunii, astfel:",
