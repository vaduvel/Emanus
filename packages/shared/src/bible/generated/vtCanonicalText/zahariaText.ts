...
export const ZAHARIA_TEXT: Readonly<Record<number, readonly string[]>> = {
  1: [
    ...
    "De aceea așa vorbește DOMNUL: „Mă întorc cu îndurarea către Ierusalim; Casa Mea va fi zidită iarăși în el, și funia de măsurat se va întinde asupra Ierusalimului.”",
    "Strigă din nou și zi: „Așa vorbește DOMNUL oștirilor: „Cetățile Mele vor avea iarăși belșug de bunătăți, DOMNUL va mângâia iarăși Sionul, va alege iarăși Ierusalimul.””",
    ...
    "Eu am întrebat: „Ce vor să facă aceștia?” Și el a zis: „Aceștia vin să sperie coarnele care au risipit pe Iuda, de n-a mai putut ridica nimeni capul; fierarii aceștia au venit să sperie și să taie coarnele neamurilor care au ridicat cornul împotriva țării lui Iuda ca să-i risipească locuitorii.”",
  ],
  2: [
    ...
    "DOMNUL va lua în stăpânire pe Iuda, ca partea Lui de moștenire în pământul sfânt, și va alege iarăși Ierusalimul.",
    "„Orice făptură să tacă înaintea DOMNULui, căci El S-a și sculat din locașul Lui cel sfânt!”",
  ],
  3: [
    "El (îngerul) mi-a arătat pe marele preot Iosua stând în picioare înaintea Îngerului DOMNULui și pe Satana stând la dreapta lui ca să-l pârască.",
    ...
    "Dar Iosua era îmbrăcat cu haine murdare și totuși stătea în picioare înaintea Îngerului.",
    "Iar Îngerul, luând cuvântul, a zis celor ce erau înaintea Lui: „Dezbrăcați-l de hainele murdare de pe el!” Apoi a zis lui Iosua: „Iată că îndepărtez de la tine nelegiuirea și te îmbrac cu haine de sărbătoare!”",
    ...
    "Ascultă, dar, Iosua, mare preot, tu și tovarășii tăi de slujbă care stau înaintea ta – căci aceștia sunt niște oameni care vor sluji ca semne. – Iată, voi aduce pe Robul Meu, Odrasla.",
  ...
  5: [
    ...
    "El a spus: „Aceasta este Răutatea!” A împins-o înapoi în mijlocul efei și a aruncat greutatea de plumb peste gura ei.",
  ...
  6: [
    ...
    "Și să-i spui: „Așa vorbește DOMNUL oștirilor: „Iată că un om, al cărui nume este Odrasla, va odrăsli din locul Lui și va zidi Templul DOMNULui.””",
  ...
  7: [
    ...
    "„Ci i-am împrăștiat printre toate neamurile pe care nu le cunoșteau; țara a fost pustiită în urma lor, așa că nimeni nu mai venea și nu mai pleca din ea; și dintr-o țară plăcută cum era, au făcut un pustiu!”",
  ],
  8: [
    ...
    "„După cum ați fost un blestem între neamuri, casa lui Iuda și casa lui Israel, tot astfel vă voi mântui, și veți fi o binecuvântare. Nu vă temeți, ci întăriți-vă mâinile!”",
    ...
    "Așa vorbește DOMNUL oștirilor: „În zilele acelea, zece oameni din toate limbile neamurilor vor apuca pe un iudeu de poala hainei și-i vor zice: „Vrem să mergem cu voi; căci am auzit că Dumnezeu este cu voi!””",
  ],
  9: [
    "Iată prorocia, cuvântul DOMNULui despre țara Hadrac; și va începe din Damasc. Căci DOMNUL are ochiul îndreptat asupra oamenilor și peste toate semințiile lui Israel.",
    ...
    "„Căci Îmi încordez pe Iuda ca arc și iau pe Efraim ca săgeată, și voi scula pe copiii tăi, Sioane, împotriva copiilor tăi, Grecio! Te voi face ca sabia unui viteaz!”",
  ...
  10: [
    ...
    "„Mânia Mea s-a aprins împotriva păstorilor și voi pedepsi pe țapi. Căci DOMNUL oștirilor Își cercetează turma, casa lui Iuda, și o va face ca pe calul Său de slavă în luptă.”",
    "Din el va ieși Piatra din capul unghiului, din el va ieși țărușul, din el va ieși arcul de război; din el vor ieși toate căpeteniile laolaltă.",
    ...
    "Îi voi aduce înapoi din țara Egiptului și-i voi aduna din Asiria; îi voi aduce în țara Galaadului și în Liban, și nu le va ajunge locul.",
    "Israel va trece prin strâmtorile mării, va lovi valurile mării, și toate adâncimile râului Nil se vor usca; mândria Asiriei va fi frântă, și toiagul de cârmuire al Egiptului va pieri.",
  ...
  11: [
    ...
    "Am nimicit cu desăvârșire pe cei trei păstori într-o lună: sufletul meu nu-i mai răbda și se scârbise și sufletul lor de mine.",
    ...
    "Mi-am luat toiagul numit „Bunăvoință” și l-am rupt, ca să desființez legământul pe care îl încheiasem cu toate popoarele.",
    "Și când s-a rupt, în ziua aceea, nenorocitele acelea de oi care au luat seama la mine au cunoscut astfel că acesta era cuvântul DOMNULui.",
    ...
    "Căci iată că voi ridica în țară un păstor căruia nu-i va păsa de oile care pier; nu se va duce să caute pe cele mai tinere, nu va vindeca pe cele rănite, nu va îngriji de cele sănătoase; ci va mânca din carnea celor mai grase și nu le va mai lăsa decât copitele!",
  ...
  12: [
    ...
    "„Iată, voi preface Ierusalimul într-un potir de amețire pentru toate popoarele dimprejur și chiar pentru Iuda, la împresurarea Ierusalimului.”",
    ...
    "DOMNUL va mântui mai întâi corturile lui Iuda, pentru ca slava casei lui David și fala locuitorilor Ierusalimului să nu se înalțe peste Iuda.",
    "În ziua aceea, DOMNUL va ocroti pe locuitorii Ierusalimului, așa că cel mai slab dintre ei va fi în ziua aceea ca David; și casa lui David va fi ca Dumnezeu, ca Îngerul DOMNULui înaintea lor.",
  ...
  14: [
    ...
    "Picioarele Lui vor sta în ziua aceea pe Muntele Măslinilor, care este în fața Ierusalimului, spre răsărit; Muntele Măslinilor se va despica la mijloc, spre răsărit și spre apus, și se va face o vale foarte mare: jumătate din munte se va trage înapoi spre miazănoapte, iar jumătate, spre miazăzi.",
    ...
    "Dar iată urgia cu care va lovi DOMNUL pe toate popoarele care vor lupta împotriva Ierusalimului: Le va putrezi carnea stând încă în picioare, le vor putrezi ochii în găurile lor și le va putrezi limba în gură.",
    ...
    "Toți cei ce vor mai rămâne din toate neamurile venite împotriva Ierusalimului se vor sui în fiecare an să se închine înaintea Împăratului, DOMNUL oștirilor, și să prăznuiască sărbătoarea Corturilor.",
    ...
    "Orice oală din Ierusalim și din Iuda va fi închinată DOMNULui oștirilor; toți cei ce vor aduce jertfe vor veni și se vor sluji de ele ca să-și fiarbă carnea; și nu vor mai fi canaaniți în Casa DOMNULui oștirilor, în ziua aceea.",
  ],
}
