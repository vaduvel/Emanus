...
export const VT_CANONICAL_TEXT_BOOKS: readonly CanonicalOverlayTextBook[] = [
  ...
  { bookId: "ioel", bibleEmanusBookId: "JOL", name: "Ioel", order: 29, chapterCount: 3, verseCount: 73, chapters: IOEL_TEXT, textStage: "temporary-editorial", translationLabel: TEMP_LABEL },
  { bookId: "amos", bibleEmanusBookId: "AMO", name: "Amos", order: 30, chapterCount: 9, verseCount: 146, chapters: AMOS_TEXT, textStage: "temporary-editorial", translationLabel: TEMP_LABEL },
  { bookId: "obadia", bibleEmanusBookId: "OBA", name: "Obadia", order: 31, chapterCount: 1, verseCount: 21, chapters: OBADIA_TEXT, textStage: "temporary-editorial", translationLabel: TEMP_LABEL },
  ...
  { bookId: "hagai", bibleEmanusBookId: "HAG", name: "Hagai", order: 37, chapterCount: 2, verseCount: 38, chapters: HAGAI_TEXT, textStage: "temporary-editorial", translationLabel: TEMP_LABEL },
