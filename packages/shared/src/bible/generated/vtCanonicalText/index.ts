...
export const VT_CANONICAL_TEXT_BOOKS: readonly CanonicalOverlayTextBook[] = [
  ...
  { bookId: "mica", bibleEmanusBookId: "MIC", name: "Mica", order: 33, chapterCount: 7, verseCount: 105, chapters: MICA_TEXT, textStage: "biblia-emanus", translationLabel: "Biblia Emanus" },
  ...
  { bookId: "habacuc", bibleEmanusBookId: "HAB", name: "Habacuc", order: 35, chapterCount: 3, verseCount: 56, chapters: HABACUC_TEXT, textStage: "biblia-emanus", translationLabel: "Biblia Emanus" },
  ...
  { bookId: "zaharia", bibleEmanusBookId: "ZEC", name: "Zaharia", order: 38, chapterCount: 14, verseCount: 211, chapters: ZAHARIA_TEXT, textStage: "biblia-emanus", translationLabel: "Biblia Emanus" },
  { bookId: "maleahi", bibleEmanusBookId: "MAL", name: "Maleahi", order: 39, chapterCount: 4, verseCount: 55, chapters: MALEAHI_TEXT, textStage: "biblia-emanus", translationLabel: "Biblia Emanus" },
] as const
