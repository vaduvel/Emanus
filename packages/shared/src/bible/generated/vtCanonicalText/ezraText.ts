...
// Sursă de lucru: Text biblic provizoriu pentru lucru editorial — de înlocuit cu Biblia Emanus; EZR, 10 capitole; nu edita manual.

export const EZRA_TEXT: Readonly<Record<number, readonly string[]>> = {
  1: [
    ...
    "Și toți cei dimprejurul lor le-au dat lucruri de argint, de aur, avere, vite și lucruri scumpe, afară de toate darurile de bunăvoie.",
    "Împăratul Cirus a dat înapoi uneltele Casei DOMNULUI pe care le luase Nebucadnețar din Ierusalim și le pusese în casa dumnezeului său.",
    "Cirus, împăratul perșilor, le-a scos prin Mitredat, vistiernicul, care le-a dat lui Șeșbațar voievodul lui Iuda.",
    "Iată-le numărul: treizeci de lighene de aur, o mie de lighene de argint, douăzeci și nouă de cuțite,",
    "treizeci de potire de aur, patru sute zece potire de argint de mâna a doua și o mie de alte unelte.",
    "„Toate lucrurile de aur și de argint erau în număr de cinci mii patru sute. Șeșbațar a adus tot din Babilon la Ierusalim, împreună cu cei ce s-au întors din robie.”",
  ],
  2: [
    ...
    "fiii lui Pahat-Moab, din fiii lui Iosua și lui Ioab, două mii opt sute doisprezece;",
    ...
    "fiii lui Betleem, o sută douăzeci și trei;",
    "oamenii din Netofa, cincizeci și șase;",
    "oamenii din Anatot, o sută douăzeci și opt;",
    "fiii lui Azmavet, patruzeci și doi;",
    "fiii lui Chiriat-Arim, Chefirei și Beerotului, șapte sute patruzeci și trei;",
    ...
    "fiii lui Nebo, cincizeci și doi;",
    "fiii lui Magbiș, o sută cincizeci și șase;",
    "fiii celuilalt Elam, o mie două sute cincizeci și patru;",
    "fiii lui Harim, trei sute douăzeci;",
    "fiii lui Lod, lui Hadid și lui Ono, șapte sute douăzeci și cinci;",
  ...
  3: [
    ...
    "Au așezat din nou altarul pe temeliile lui, măcar că au avut să se teamă de popoarele țării, și au adus arderi de tot DOMNULUI, arderile de tot de dimineață și de seară.",
    ...
    "După aceea au adus arderea de tot necurmată, arderile de tot pentru fiecare lună nouă și pentru toate sărbătorile închinate DOMNULUI, afară de cele pe care le aducea fiecare ca daruri de bunăvoie DOMNULUI.",
    "Din cea dintâi zi a lunii a șaptea au început să aducă DOMNULUI arderi de tot. Însă temeliile Templului DOMNULUI nu erau încă puse.",
    "Au dat argint cioplitorilor de piatră și tâmplarilor, și merinde, băuturi și untdelemn, sidonienilor și tirienilor, ca să aducă pe mare, până la Iafo, lemne de cedru din Liban, după învoirea dată de Cirus, împăratul perșilor.",
    ...
    "Când au pus lucrătorii temeliile Templului DOMNULUI, au așezat pe preoți în veșminte, cu trâmbițe, și pe leviți, fiii lui Asaf, cu chimvale, ca să laude pe DOMNUL, după rânduiala lui David, împăratul lui Israel.",
    ...
    "așa încât nu se putea deosebi glasul strigătelor de bucurie de glasul plânsetelor poporului; căci poporul scotea mari strigăte, al căror sunet se auzea de departe.",
  ],
  4: [
    ...
    "Și, fiindcă noi mâncăm sarea curții domnești și nu ne șade bine să vedem pe împărat păgubit, trimitem împăratului aceste știri.",
    ...
    "„Facem cunoscut împăratului că, dacă va fi zidită din nou cetatea aceasta și dacă i se vor ridica zidurile, prin chiar faptul acesta, nu vei mai avea stăpânire dincoace de Râu.”",
  ...
  5: [
    "Prorocii: Hagai, prorocul, și Zaharia, fiul lui Ido, au prorocit iudeilor care erau în Iuda și la Ierusalim în Numele Dumnezeului lui Israel.",
    ...
    "Dar ochiul lui Dumnezeu veghea asupra bătrânilor iudeilor. Și au lăsat să meargă înainte lucrările până la trimiterea unei înștiințări către Darius și până la primirea unei scrisori de la el în această privință.",
    "Iată cuprinsul scrisorii trimise împăratului Darius de Tatnai, dregătorul de dincoace de Râu, de Șetar-Boznai și tovarășii lor din Afarsac care locuiau dincoace de Râu.",
    ...
    "Le-am cerut și numele lor ca să ți le facem cunoscut și am pus în scris numele oamenilor care sunt în fruntea lor.",
    "Iată răspunsul pe care ni l-au dat: „Noi suntem slujitorii Dumnezeului cerurilor și al pământului și zidim din nou Casa care fusese zidită acum mulți ani. Un mare împărat al lui Israel o zidise și o isprăvise.”",
    "Dar, după ce părinții noștri au mâniat pe Dumnezeul cerurilor, El i-a dat în mâinile lui Nebucadnețar, împăratul Babilonului, haldeianul, care a nimicit Casa aceasta și a luat pe popor rob la Babilon.",
    "Totuși în cel dintâi an al lui Cirus, împăratul Babilonului, împăratul Cirus a dat poruncă să se zidească din nou această Casă a lui Dumnezeu.",
    ...
    "„„Acum, dacă împăratul găsește cu cale, să se facă cercetări în casa vistieriilor împăratului la Babilon, ca să vadă dacă s-a dat din partea împăratului Cirus o poruncă pentru zidirea Casei acesteia a lui Dumnezeu la Ierusalim. Apoi, să ne trimită împăratul voința lui asupra acestui lucru.””",
  ],
  6: [
    ...
    "„În anul întâi al domniei împăratului Cirus, împăratul Cirus a dat această poruncă privitoare la Casa lui Dumnezeu din Ierusalim: „Casa să fie zidită iarăși, ca să fie un loc unde să se aducă jertfe și să aibă temelii tari. Să aibă o înălțime de șaizeci de coți, o lățime de șaizeci de coți,””",
    "trei rânduri de pietre cioplite și un rând de lemn nou. Cheltuielile vor fi plătite din casa împăratului.",
    "„Mai mult, uneltele de aur și de argint ale Casei lui Dumnezeu, pe care le luase Nebucadnețar din Templul de la Ierusalim și le adusese la Babilon, să fie date înapoi, duse în Templul din Ierusalim, la locul unde erau, și puse în Casa lui Dumnezeu.”",
    "Acum, Tatnai, dregătorul de dincolo de Râu, Șetar-Boznai și tovarășii voștri de slujbă din Afarsac, care locuiți dincolo de Râu, depărtați-vă de locul acesta.",
    ...
    "Iată porunca pe care o dau cu privire la ce veți avea de făcut față de acești bătrâni ai iudeilor, pentru zidirea acestei Case a lui Dumnezeu: cheltuielile, luate din averile împăratului venite din birurile de dincolo de Râu, să fie plătite îndată oamenilor acestora ca să nu înceteze lucrul.",
    "Lucrurile trebuincioase pentru arderile de tot ale Dumnezeului cerurilor, viței, berbeci și miei, grâu, sare, vin și untdelemn, să li se dea, la cerere, preoților din Ierusalim, zi de zi și fără nicio lipsă,",
    "ca să aducă jertfe de bun miros Dumnezeului cerurilor și să se roage pentru viața împăratului și a fiilor lui.",
    ...
    "„Dumnezeul care a pus să locuiască în locul acela Numele Lui să răstoarne pe orice împărat și pe orice popor care ar întinde mâna să calce cuvântul meu ca să nimicească această Casă a lui Dumnezeu din Ierusalim! Eu, Darius, am dat porunca aceasta. Să fie împlinită întocmai.”",
    "Tatnai, dregătorul de dincoace de Râu, Șetar-Boznai și tovarășii lor de slujbă au împlinit întocmai porunca aceasta pe care le-a trimis-o împăratul Darius.",
    "Și bătrânii iudeilor au zidit cu izbândă, după prorociile prorocului Hagai și ale lui Zaharia, fiul lui Ido; au zidit și au isprăvit, după porunca Dumnezeului lui Israel și după porunca lui Cirus, lui Darius și lui Artaxerxe, împăratul perșilor.",
    "Casa a fost isprăvită în ziua a treia a lunii Adar, în al șaselea an al domniei împăratului Darius.",
    "Copiii lui Israel, preoții și leviții, și ceilalți fiii ai robiei au făcut cu bucurie sfințirea acestei Case a lui Dumnezeu.",
    "Au adus pentru sfințirea acestei Case a lui Dumnezeu o sută de viței, două sute de berbeci, patru sute de miei și, ca jertfe ispășitoare pentru tot Israelul, doisprezece țapi, după numărul semințiilor lui Israel.",
    "Au pus pe preoți, după cetele lor, și pe leviți, după împărțirile lor, pentru slujba lui Dumnezeu la Ierusalim, cum este scris în cartea lui Moise.",
    "Fiii robiei au prăznuit Paștile în a paisprezecea zi a lunii întâi.",
    "Preoții și leviții se curățaseră cu toții, așa că toți erau curați; au jertfit paștile pentru toți fiii robiei, pentru frații lor, preoții, și pentru ei înșiși.",
    "Copiii lui Israel întorși din robie au mâncat paștile împreună cu toți cei ce se depărtaseră de necurăția neamurilor țării și care s-au unit cu ei ca să caute pe DOMNUL Dumnezeul lui Israel.",
    "Au prăznuit cu bucurie șapte zile sărbătoarea Azimelor, căci DOMNUL îi înveselise făcând pe împăratul Asiriei să-i sprijine în lucrarea Casei lui Dumnezeu, Dumnezeul lui Israel.",
  ],
  7: [
    ...
    "Ezra a venit la Ierusalim în a cincea lună a anului al șaptelea al împăratului.",
    ...
    "Căci Ezra își pusese inima să adâncească și să împlinească Legea DOMNULUI, și să învețe pe oameni în mijlocul lui Israel legile și poruncile.",
    "Iată cuprinsul scrisorii date de împăratul Artaxerxe preotului și cărturarului Ezra, care învăța poruncile și legile DOMNULUI cu privire la Israel:",
    ...
    "Tu ești trimis de împăratul și de cei șapte sfetnici ai lui să cercetezi în Iuda și Ierusalim, după Legea Dumnezeului tău care este în mâinile tale,",
    "și să duci argintul și aurul pe care împăratul și sfetnicii săi l-au dăruit cu dragă inimă Dumnezeului lui Israel, a cărui locuință este la Ierusalim,",
    "tot argintul și aurul pe care-l vei găsi în tot ținutul Babilonului și darurile de bunăvoie făcute de popor și preoți pentru Casa Dumnezeului lor la Ierusalim.",
    ...
    "Pune înaintea Dumnezeului din Ierusalim uneltele care-ți vor fi încredințate pentru slujba Casei Dumnezeului tău.",
    ...
    "Eu, împăratul Artaxerxe, dau poruncă tuturor vistiernicilor de dincolo de Râu să dea îndată lui Ezra, preot și cărturar iscusit în Legea Dumnezeului cerurilor, tot ce vă va cere,",
    "până la o sută de talanți de argint, o sută de cori de grâu, o sută de bați de vin, o sută de bați de untdelemn și sare câtă va vrea.",
    "Tot ce este poruncit de Dumnezeul cerurilor să se facă întocmai pentru Casa Dumnezeului cerurilor, pentru ca să nu vină mânia Lui asupra împărăției, asupra împăratului și asupra fiilor săi.",
    "Vă facem cunoscut că nu puteți pune nici bir, nici dare, nici vamă de trecere peste niciunul din preoți, din leviți, din cântăreți, din ușieri, din slujitorii Templului și din slujitorii acestei Case a lui Dumnezeu.",
    "Și tu, Ezra, după înțelepciunea lui Dumnezeu pe care o ai, pune judecători și dregători care să facă dreptate la tot poporul de dincolo de Râu, tuturor celor ce cunosc legile Dumnezeului tău; și fă-le cunoscut celor ce nu le cunosc.",
    ...
    "„Binecuvântat să fie DOMNUL Dumnezeul părinților noștri, care a pregătit inima împăratului ca să slăvească astfel Casa DOMNULUI la Ierusalim”",
    "„și a îndreptat asupra mea bunăvoința împăratului, a sfetnicilor săi și a tuturor căpeteniilor puternice ale lui! Întărit de mâna DOMNULUI Dumnezeului meu care era asupra mea, am strâns pe căpeteniile lui Israel, ca să plece cu mine.”",
  ],
  8: [
    ...
    "Îmi era rușine să cer împăratului o oaste de însoțire și călăreți, ca să ne ocrotească împotriva vrăjmașului pe drum, căci spusesem împăratului: „Mâna Dumnezeului nostru este, spre binele lor, peste toți cei ce-L caută, dar puterea și mânia Lui sunt peste toți cei ce-L părăsesc.”",
  ...
  9: [
    ...
    "pe care ni le porunciseși prin robii Tăi prorocii, zicând: „Țara în care intrați s-o stăpâniți este o țară întinată de necurățiile popoarelor din aceste ținuturi, de urâciunile cu care au umplut-o de la un capăt la altul cu necurățiile lor.”",
  ...
  10: [
    ...
    "din fiii lui Elam: Matania, Zaharia, Iehiel, Abdi, Ieremot și Ilie;",
    "dintre fiii lui Zatu: Elioenai, Eliașib, Matania, Ieremot, Zabad și Aziza;",
