...
export const BIBLIA_EMANUS_NT_TRANSLATION: BibleTranslation = {
  id: "BE",
  name: "Biblia Emanus (BE)",
  attribution: "Biblia Emanus; SBL Greek New Testament, CC BY 4.0",
}
...
export function buildBibliaEmanusNtBooks(corpus: BibliaEmanusNtCorpus): BibleBook[] {
  return NT_BOOKS.map((book) => {
    ...
    return {
      ...
      translation: BIBLIA_EMANUS_NT_TRANSLATION,
