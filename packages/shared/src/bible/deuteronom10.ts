...
export const DEUTERONOM_10 = deuteronomChapter({
  ...
  historicalContext:
    "Chivotul legământului, făcut din lemn de salcâm, avea să poarte cele două table noi ale Legii până în Templul lui Solomon. Seminția Leviei a fost aleasă să slujească în locul preoției și să nu primească moștenire de pământ, ci să aibă pe DOMNUL însuși ca partea lor.",
  units: [
    {
      ...
      teaching: teaching(
        ...
        "Moise construiește un chivot de lemn de salcâm ca să primească tablele, punând acolo cuvântul lui Dumnezeu „cum a fost mai înainte”. Cuvintele scrise din nou sunt identice cu cele scrise prima dată; Legea nu se schimbă de la o versiune la alta, ci este restaurată exact.",
      ),
      words: [
        {
          ...
          language: "ebraica",
          meaning:
            "chivot de lemn de salcâm. Materialul și construcția chivotului sunt descrise în detaliu și în Exod 25:10-16; aici este menționat sumar, ca fapt cunoscut deja.",
        },
      ],
    ...
    },
    {
      ...
      teaching: teaching(
        "Textul inserează o notație de călătorie și moartea lui Aaron la Moserah, unde fiul lui Eleazar Îl urmează în slujba preoțească. Chiar cel mai mare preot al legământului nu trăiește pentru totdeauna; slujba continuă dincolo de persoana care o Îndeplinește la un moment dat.",
      ...
      forYourHeart:
        "Uneori Dumnezeu nu-ți dă moștenirea pe care o aștepți, ci pe El însuși, care este mai mare decât orice moștenire pământească.",
    },
    {
      ...
      teaching: teaching(
        ...
        "Versetul 12 rezumă întreaga cerere a lui Dumnezeu într-o întrebare memorabilă: „Ce cere DOMNUL, Dumnezeul tău, de la tine, decât să te temi de DOMNUL, Dumnezeul tău, să mergi în toate căile Lui, să-L iubești și să-I slujească cu toată inima ta și cu tot sufletul tău”? Religia biblică se rezumă în patru mișcări: frică sfântă, ascultare, iubire, slujire.",
      ),
      words: [
        {
          ...
          language: "ebraica",
          meaning:
            "și acum, Israel, ce cere DOMNUL de la tine. Formula devine tema centrală a chemării profetice, citată și de Mica: „Ce cere DOMNUL de la tine: decât să faci dreptate, să iubești mila și să mergi smerit cu Dumnezeul tău”.",
        },
      ],
    ...
    },
    {
      ...
      heading: "Tăiați împrejur inima voastră",
      ...
      teaching: teaching(
        ...
        "Porunca centrală este surprinzător de intimă: „să tăiați împrejur inima voastră [circumcizia inimii] și să nu mai fiți cu grumazul țeapăn”. Circumcizia trupului, semnul legământului exterior, este nimic fără circumcizia inimii — tema care va fi dezvoltată mai târziu de proroci și de apostolul Pavel.",
        "Chemarea finală este spre iubire practică, nu abstractă: „iubiți pe străin, căci și voi ați fost străini în țara Egiptului”. Dumnezeu Însuși „face dreptate orfanului și văduvei și iubește pe străin”, și cere aceeași inimă de la poporul Său.",
      ),
      words: [
        {
          ...
          language: "ebraica",
          meaning:
            "să tăiați împrejur pielea inimii voastre. Metaforă pentru circumcizia inimii, dezvoltată mai târziu în Ieremia 4:4 și Romani 2:29.",
        },
      ],
