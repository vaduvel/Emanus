  ...
  units: [
    {
      ...
      teaching: teaching(
        "Porunca este totală și fără excepție: „să nimiciți toate locurile în care slujeau neamurile pe dumnezeii lor, pe munții înalți, pe dealuri și sub orice copac verde”, și să sfărâme altarele, stâlpii de piatră, idolii de lemn și chipurile cioplite.",
    ...
    },
    {
      ...
      teaching: teaching(
        ...
        "Interzicerea sângelui, deja stabilită din Leviticul 17:10-14, se repetă direct: „numai să nu mănânci sângele; să-l torni pe pământ ca apa”. Sângele reprezintă viața Însăși și rămâne sfințit doar pentru DOMNUL.",
      ...
      words: [
        {
          ...
          language: "ebraica",
          meaning:
            "numai sângele să nu-l mănânci. Interzicere repetată constant în Pentateuh, legată de sfințenia vieții pe care sângele o reprezintă.",
        },
      ],
