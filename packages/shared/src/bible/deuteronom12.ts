...
export const DEUTERONOM_12 = deuteronomChapter({
  ...
  summary:
    "Începe codul legilor propriu-zise cu porunca de a nimici toate locurile de Închinare canaanite și de a aduce jertfele numai în locul pe care DOMNUL însuși Îl va alege. Israel poate mînca liber carne acasă, dar cu excepția sîngelui, iar zeciuielile și jertfele trebuie duse la locul central. Capitolul se încheie cu avertismentul Împotriva cercetării felului În care neamurile se Închinau zeilor lor.",
  literaryContext:
  ...
  historicalContext:
    "Canaaniții Închinau la zeitățile lor pe „dealuri înalte”, sub copaci verzi, cu stîlpi de piatră și idoli de lemn. Israel este chemat să nimicească total aceste locuri și să nu-și Închipuiască un cult descentralizat, după modelul religiilor din jur, ci să se adune Într-un singur loc pe care DOMNUL însuși Îl va alege, mai tîrziu identificat cu Ierusalimul.",
  units: [
    {
      ...
      teaching: teaching(
        "Porunca este totală și fără excepție: „să nimiciți toate locurile În care slujeau neamurile pe dumnezeii lor, pe munții înălți, pe dealuri și sub orice copac verde”, și să sfărâame altarele, stîlpii de piatră, idolii de lemn și chipurile cioplite.",
      ...
      words: [
        {
          ...
          language: "ebraica",
          meaning:
            "sub orice copac verde. Expresie folosită frecvent În Vechiul Legămînt pentru locurile de Închinare idolatră, condamnate constant de proroci.",
        },
      ],
    ...
    },
    {
      ...
      teaching: teaching(
        "Împotriva multiplicării de locuri idolatre, DOMNUL alege un singur loc: „să căutați locul pe care Îl va alege DOMNUL, Dumnezeul vostru... ca să-și pună Numele Lui acolo”. Acest loc, neidentificat încă În text, va fi mai tîrziu Ierusalimul.",
        "Acolo, și numai acolo, trebuie duse jertfele de tot felul, zeciuielile, darurile de mînă, juruințele și primele-născute ale turmelor. Contrastul cu practica din pustie — „n-ați ajuns încă la odihna și moștenirea pe care v-o dă DOMNUL” — arată că acest sistem devine posibil abia cînd poporul se așează stabil În țară.",
      ),
      words: [
        {
          ...
          language: "ebraica",
          meaning:
            "ca să-și așeze Numele Său acolo. Formula teologică pentru locul central de Închinare, folosită mai tîrziu direct pentru Templul lui Solomon.",
        },
      ],
    ...
    },
    {
      ...
      heading: "Carne acasă, dar niciodată sîngele",
      text: deuteronomPassage(12, 13, 19),
      teaching: teaching(
        "Jertfele trebuie aduse doar la locul ales, dar viața de zi cu zi În restul țării nu este oprită: „poți tăia și mînca carne În toate cetățile tale, oricât vei pofti”. Distincția este clară: jertfa cultă se aduce la locul ales, hrana obișnuită se poate lua acasă.",
        "Interzicerea sîngelui, deja stabilită din Leviticul 17:10-14, se repetă direct: „numai să nu mînci sîngele; să-l torni pe pămînt ca apa”. Sîngele reprezintă viața Însăși și rămâne sfințit doar pentru DOMNUL.",
        "Grija pentru Levit este specială: „să te păzești să nu lași pe levitul tău toată vremea cât vei fi În țara ta”. Cel care nu are moștenire de pămînt trebuie susținut activ de restul poporului.",
      ),
      words: [
        {
          ...
          language: "ebraica",
          meaning:
            "numai sîngele să nu-l mînci. Interzicere repetată constant în Pentateuh, legată de sfințenia vieții pe care sîngele o reprezintă.",
        },
      ],
      crossRefs: ["Leviticul 17:10-14", "Geneza 9:4", "Fapte 15:20"],
      forYourHeart:
        "Grija pentru cei fără moștenire proprie În mijlocul tău nu este opțională; este parte a legămîntului.",
    },
    {
      id: "deuteronom-12-20-28",
      ref: "Deuteronom 12:20-28",
      heading: "Cînd țara se va întinde",
      text: deuteronomPassage(12, 20, 28),
      teaching: teaching(
        "Legea pregătește dinainte pentru creșterea teritoriului: „cînd DOMNUL înși va întinde ținuturile, cum ți-a făgăduit”, și repetă aceeași îngăduință pentru carnea obișnuită, cu aceeași interzicere a sîngelui.",
      ...
      words: [
        {
          ...
          language: "ebraica",
          meaning:
            "cînd DOMNUL înși va întinde granițele. Făgăduință de creștere teritorială pentru care legea pregătește din timp reguli practice.",
        },
      ],
