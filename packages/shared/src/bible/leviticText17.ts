/*
 * Textul biblic al cărții Levitic, capitolul 17.
 *
 * ATENȚIE, agentul care lucrează la Biblia Emanus:
 * fișierul acesta ține LOCUL textului, nu textul. Fiecare intrare din tablou
 * este un verset, în ordine, de la 1 la 16. Înlocuiește fiecare șir cu versetul
...
export const LEVITIC_TEXT_17: Record<number, readonly string[]> = {
  17: Array.from({ length: 16 }, (_, i) => `[Levitic 17:${i + 1}] ${PLACEHOLDER}`),
}
