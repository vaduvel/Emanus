/*
 * Textul biblic al cărții Levitic, capitolul 18.
 *
...
export const LEVITIC_TEXT_18: Record<number, readonly string[]> = {
  18: Array.from({ length: 30 }, (_, i) => `[Levitic 18:${i + 1}] ${PLACEHOLDER}`),
}
