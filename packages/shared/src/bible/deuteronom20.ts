...
export const DEUTERONOM_20 = deuteronomChapter({
  ...
  literaryContext:
    "Deuteronom 20 se află în discursul lung al lui Moise despre viața poporului în țară. Poonen se oprește la începutul capitolului și îl aplică vieții de ucenicie; nu dezvoltă în transcript fiecare detaliu al legilor de război din a doua jumătate. De aceea păstrăm bogată aplicația pe care el chiar o face și nu îi atribuim explicații pe care nu le-a dat.",
  historicalContext:
    "Poruncile militare aparțin cadrului istoric al Israelului și cuceririi țării. Aplicația lui Poonen despre priorități nu transformă războaiele Israelului într-un model pentru violență creștină modernă; ea pornește de la oamenii trimiși acasă fiindcă alte lucruri le stăpâneau interesul sau fiindcă frica lor îi putea slăbi pe ceilalți.",
  units: [
    {
      ...
      teaching: teaching(
        ...
        "Nu îndulcim această aplicație. Poonen nu spune că o casă, o soție sau o slujbă sunt rele; spune că ele nu pot ocupa locul întâi în omul care vrea să fie disponibil pentru Dumnezeu. Problema nu este existența acestor daruri, ci o inimă împărțită.",
    ...
    },
    {
      ...
      teaching: teaching(
        ...
        "Versetul 15 precizează că această procedură se aplică cetăților foarte îndepărtate, care nu aparțin cetăților popoarelor enumerate în versetele următoare. Nu facem din această «ofertă de pace» o regulă spirituală inventată și nici nu îi atribuim lui Poonen o aplicație pe care transcriptul lui nu o dezvoltă.",
      ),
    ...
    },
    {
      ...
      teaching: teaching(
        ...
        "Versetele 19–20 tratează asediul prelungit. Pomii din care se poate mânca nu trebuie tăiați pentru lucrările de asediu; pomii cunoscuți ca neroditori pot fi folosiți până la căderea cetății. Aceste porunci aparțin războiului lui Israel din acest context. Nu le convertim într-o autorizație pentru război religios modern și nici nu inventăm o aplicație Poonen acolo unde transcriptul nu o oferă.",
      ),
      explanationKind: "textual-overview",
      explanationSource: TEXTUAL_SOURCE,
    },
  ...
  prayer:
    "Doamne, scapă-ne și de frică, și de o inimă împărțită. Nu lăsa casa, banii, munca sau relațiile să ia locul care Îți aparține. Și dă-ne teamă de Tine ca să nu folosim războaiele Israelului drept scuză pentru violența noastră. Amin.",
