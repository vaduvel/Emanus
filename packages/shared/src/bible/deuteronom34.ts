...
export const DEUTERONOM_34 = deuteronomChapter({
  ...
  units: [
    {
      ...
      teaching: teaching(
        "DOMNUL insusi ii arata lui Moise „toata tara: Galaadul pana la Dan... toata tara lui Iuda pana la Marea de Apus” - o panorama completa a promisiunii făcute lui Avraam, Isaac si Iacov, văzută cu proprii ochi chiar de cel care nu va intra in ea.",
        "Cuvintele DOMNULUI sunt directe si fara ambiguitate: „Ti-am aratat-o cu ochii tai, dar nu vei trece in ea.” Consecinta pacatului de la Meriba rămâne in vigoare, dar este îmblânzită de darul vederii depline a implinirii promisiunii, chiar fara a o experimenta personal.",
      ),
      words: [
        {
    ...
    },
    {
      ...
      teaching: teaching(
        "Moise este numit la finalul vietii sale „slujitorul DOMNULUI” - titlul cel mai înalt posibil, care rezuma intreaga sa activitate. Moartea sa vine „dupa cuvântul DOMNULUI”, nu ca un accident, ci ca împlinire a unei hotarari cunoscute dinainte.",
        "Detaliul remarcabil este păstrarea tainei mormantului: „nimeni nu-i cunoaste mormantul pana in ziua de astăzi”. In ciuda acestui fapt, poporul il jeleste deplin - „treizeci de zile” - arătând cinstea reala pentru conducătorul lor, fara a avea nevoie de un loc de pelerinaj pentru a o exprima.",
      ),
      words: [
        {
  ...
  prayer:
    "Doamne, multumim pentru viata lui Moise, slujitorul Tau credincios pana la ultima suflare.\n\nAjuta-ne sa ne bucuram de implinirea promisiunilor Tale, chiar si atunci când nu le vedem deplin cu ochii noștri.\n\nDa-ne intelepciune sa primim si sa susținem pe cei pe care ii pregătești sa continue lucrarea începută de alții înaintea noastra.\n\nSi multumim ca așteptarea unui Proroc mai mare ca Moise este împlinită deplin in Hristos, Cuvântul Tau intrupat. Amin.",
