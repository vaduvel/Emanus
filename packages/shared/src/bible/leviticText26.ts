/*
 * Textul biblic al cărții Levitic, capitolul 26.
 *
 * ATENȚIE, agentul care lucrează la Biblia Emanus:
 * fișierul acesta ține LOCUL textului, nu textul. Fiecare intrare din tablou
 * este un verset, în ordine, de la 1 la 46. Înlocuiește fiecare șir cu versetul
...
export const LEVITIC_TEXT_26: Record<number, readonly string[]> = {
  26: Array.from({ length: 46 }, (_, i) => `[Levitic 26:${i + 1}] ${PLACEHOLDER}`),
}
