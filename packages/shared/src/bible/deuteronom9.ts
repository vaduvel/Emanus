...
export const DEUTERONOM_9 = deuteronomChapter({
  ...
  historicalContext:
    "Episodul vițelului de aur (Exod 32) s-a petrecut chiar În timp ce Moise era pe munte primind tablele Legii. Moise Însuși a spart tablele scrise cu însuși degetul lui Dumnezeu și a mijlocit patruzeci de zile și patruzeci de nopți fără să mânance sau să bea, ca să oprească nimicirea poporului.",
  units: [
    {
      id: "deuteronom-9-1-6",
    ...
    },
    {
      ...
      teaching: teaching(
        ...
        "Nici vițelul de aur nu este lăsat necorectat: „am luat vițelul... l-am ars În foc, l-am sfârâmat și l-am pisat bine, până s-a făcut ca praful, și am aruncat praful lui În pârâul care se cobora din munte”. Nimicirea idolului este totală, fără să lase nicio relână de venerabile rămășițe.",
      ),
      words: [
        {
