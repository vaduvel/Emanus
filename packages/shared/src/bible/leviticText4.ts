/*
 * Textul biblic al cărții Levitic, capitolul 4.
 *
...
export const LEVITIC_TEXT_4: Record<number, readonly string[]> = {
  4: Array.from({ length: 35 }, (_, i) => `[Levitic 4:${i + 1}] ${PLACEHOLDER}`),
}
