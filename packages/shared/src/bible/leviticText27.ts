/*
 * Textul biblic al cărții Levitic, capitolul 27.
 *
...
export const LEVITIC_TEXT_27: Record<number, readonly string[]> = {
  27: Array.from({ length: 34 }, (_, i) => `[Levitic 27:${i + 1}] ${PLACEHOLDER}`),
}
