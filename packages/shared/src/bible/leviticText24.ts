/*
 * Textul biblic al cărții Levitic, capitolul 24.
 *
 * ATENȚIE, agentul care lucrează la Biblia Emanus:
 * fișierul acesta ține LOCUL textului, nu textul. Fiecare intrare din tablou
 * este un verset, în ordine, de la 1 la 23. Înlocuiește fiecare șir cu versetul
...
export const LEVITIC_TEXT_24: Record<number, readonly string[]> = {
  24: Array.from({ length: 23 }, (_, i) => `[Levitic 24:${i + 1}] ${PLACEHOLDER}`),
}
