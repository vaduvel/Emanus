export const LUCA_SOURCE = {
  ...
  poonen: {
    ...
    manifest: "docs/data/luca-poonen-source.json",
    verifiedEpisodeCount: 24,
    controllingTheme: "Isus Hristos — Omul plin de Duhul Sfânt",
    themes: [
      "lucrarea Duhului Sfânt",
      "rămășița credincioasă",
      "nașterea și botezul lui Isus",
      "minunile și învățătura",
      "femeile binecuvântate și implicate în slujire",
      "o inimă largă pentru ceilalți",
      "pildele și mesajul lor practic",
      "ucenicia, căderea și restaurarea",
      "învățătura despre bani",
      "revenirea lui Hristos",
      "Cina, crucea și învierea",
    ],
  },
  editorial: {
    status: "in_review",
