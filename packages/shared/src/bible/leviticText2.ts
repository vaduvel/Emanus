/*
 * Textul biblic al cărții Levitic, capitolul 2.
 *
...
export const LEVITIC_TEXT_2: Record<number, readonly string[]> = {
  2: Array.from({ length: 16 }, (_, i) => `[Levitic 2:${i + 1}] ${PLACEHOLDER}`),
}
