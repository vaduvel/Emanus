/*
 * Textul biblic al cărții Levitic, capitolul 8.
 *
...
export const LEVITIC_TEXT_8: Record<number, readonly string[]> = {
  8: Array.from({ length: 36 }, (_, i) => `[Levitic 8:${i + 1}] ${PLACEHOLDER}`),
}
