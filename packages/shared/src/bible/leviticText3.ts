/*
 * Textul biblic al cărții Levitic, capitolul 3.
 *
...
export const LEVITIC_TEXT_3: Record<number, readonly string[]> = {
  3: Array.from({ length: 17 }, (_, i) => `[Levitic 3:${i + 1}] ${PLACEHOLDER}`),
}
