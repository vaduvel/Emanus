export const FILIPENI_SOURCE = {
  ...
  scripture: {
    ...
    importConfig: "docs/data/filipeni-rccv-import.json",
    generatedAtBuild: true,
    publicLaunchRights: "unresolved",
  },
  poonen: {
    officialVerseByVerse: "https://www.cfcindia.com/verse-by-verse/Philippians",
    manifest: "docs/data/filipeni-poonen-source.json",
    verifiedEpisodeCount: 4,
    themes: [
      "bucurie în Hristos",
      "Evanghelia înaintând prin încercare",
      "gândul smerit al lui Hristos",
      "ascultare și lumină în lume",
      "cunoașterea lui Hristos mai presus de câștig",
      "alergarea spre premiul chemării",
      "pacea lui Dumnezeu în îngrijorare",
      "mulțumire și dărnicie fără manipulare",
    ],
  },
  editorial: {
    status: "in_review",
