...
import { restoreIeremia29FinalPoonenFidelity } from "./ieremia29FinalPoonenFidelityReview.js"
import { restoreIeremiaPoonenFidelity } from "./ieremiaPoonenFidelityReview.js"
...
const IEREMIA_EDITORIAL_REVIEWED = restoreIeremia29FinalPoonenFidelity(
  restoreIeremiaPoonenFidelity(
    reviewIeremia23_29_31Explanations(IEREMIA_EDITORIAL_BASE),
  ),
)
