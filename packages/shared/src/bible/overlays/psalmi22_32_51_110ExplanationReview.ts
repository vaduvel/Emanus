...
const PSALMUL_22: ExplainedOverlayChapter = {
  number: 22,
  title: "Psalmul 22 — De la strigătul Crucii la laudă, închinare și o sămânță care Îi slujește",
  summary:
    "Psalmul începe cu strigătul «Dumnezeul Meu, Dumnezeul Meu, pentru ce M-ai părăsit?» și trece prin batjocură, suferință, împărțirea hainelor, apoi spre proclamarea Numelui lui Dumnezeu în adunare, închinarea neamurilor și o generație care va vesti dreptatea Lui. Zac Poonen citește Psalmii 22–24 ca trecut–prezent–viitor: Crucea, Păstorul și Împăratul slavei. Noul Testament leagă explicit mai multe versete din Psalmul 22 de Patimile și învierea lui Isus, astfel încât lectura mesianică este mult mai puternică decât o simplă analogie devoțională.",
  units: [
    {
      from: 1,
      to: 11,
      heading: "Strigătul pe care Isus îl rostește pe Cruce și batjocura reluată de Evanghelii",
      teaching:
        "Psalmul deschide cu un strigăt de abandon: «Dumnezeul Meu, Dumnezeul Meu, pentru ce M-ai părăsit?» Isus rostește aceste cuvinte pe Cruce în Matei 27:46 și Marcu 15:34. Evangheliile nu transformă astfel fiecare lamentație a lui David automat în profeție mesianică, dar pentru acest psalm ele ne obligă să luăm foarte serios dimensiunea cristologică.\n\nVersetele 7–8 descriu oameni care își bat joc, clatină capul și spun în esență: «s-a încrezut în DOMNUL; să-l scape El». Matei 27:39–43 redă tocmai această batjocură la Cruce. Legătura nu este inventată de comentatorul modern; limbajul Patimilor este modelat după psalm.\n\nÎn același timp, psalmul rămâne rugăciunea reală a unui suferind israelit. Lectura creștină nu cere să negăm primul orizont poetic, ci să recunoaștem că Noul Testament vede în experiența lui David un tipar care ajunge la împlinire culminantă în Hristos.\n\nPoonen include Psalmul 22 în grupul lui «cruce–păstor–împărat» și spune direct că vorbește despre Cruce. Această afirmație rămâne fără diluare.",
      source: {
        kind: "canonical-exegesis",
        sources: ["Psalmul 22:1-11", "Matei 27:39-46", "Marcu 15:29-34", "Zac Poonen — Through The Bible: Psalms"],
        note: "Poonen citește psalmul mesianic, iar Evangheliile folosesc explicit limbajul lui în Patimile lui Isus.",
      },
      explanationKind: "exposition",
      forYourHeart:
        "Faptul că un om al lui Dumnezeu poate striga «de ce?» nu înseamnă automat necredință. Psalmul 22 pune acest strigăt chiar pe buzele lui Mesia răstignit.",
    },
    {
      from: 12,
      to: 21,
      heading: "Trupul zdrobit, vrăjmașii care înconjoară și hainele împărțite",
      teaching:
        "Psalmistul descrie tauri, lei și câini care îl înconjoară, oase ieșite din încheieturi, inimă ca ceara, sete, mâini și picioare atacate și haine împărțite prin sorți. Unele detalii sunt poetic hiperbolice în experiența psalmistului și nu trebuie tratate ca raport medical anticipat al crucificării.\n\nDar Ioan 19:23–24 spune explicit că soldații împart hainele lui Isus și aruncă sorți pentru cămașă și citează Psalmul 22:18 ca Scriptură împlinită. Acesta este un punct de ancorare canonic foarte puternic.\n\nLa v.16 există și o problemă textuală bine cunoscută în tradiția ebraică/vechile versiuni privind formularea mâinilor și picioarelor. Emanus nu trebuie să pretindă că un singur cuvânt dificil rezolvă singur întreaga profeție a crucificării. Mesianismul Psalmului 22 nu depinde de forțarea unei variante textuale; Evangheliile oferă deja legăturile explicite.\n\nPoonen spune că Isus a fost «ca un vierme», turnat ca apa, înconjurat și că hainele au fost împărțite. Păstrăm predica lui, dar separăm imaginea poetică de afirmația istorică explicit confirmată de Noul Testament.",
      source: {
        kind: "poonen",
        transcript,
        anchor: "Psalm 22 ... Jesus was like a worm ... poured out like water ... parted his garments ... dogs surrounded him",
      },
      explanationKind: "exposition",
    },
    {
      from: 22,
      to: 31,
      heading: "După suferință: frații, adunarea, neamurile și o generație care vestește dreptatea Lui",
      teaching:
        "Tonul se schimbă radical la v.22: «voi vesti Numele Tău fraților mei; Te voi lăuda în mijlocul adunării». Evrei 2:11–12 citează acest verset despre Hristos, Care nu Se rușinează să-i numească frați pe cei sfințiți. Poonen evidențiază tocmai această trecere și spune că după Cruce rezultatul este laudă și închinare.\n\nPsalmul repetă chemarea la laudă și ajunge la toate marginile pământului care își vor aminti și se vor întoarce la DOMNUL. Împărăția Îi aparține Lui, iar o sămânță Îi va sluji și va vesti generației următoare dreptatea Lui.\n\nPoonen observă ordinea cu umor pastoral: multă laudă și închinare, apoi slujire. Punctul lui nu este că munca creștină contează puțin, ci că slujirea nu trebuie să înlocuiască uimirea, lauda și închinarea născute din Cruce.\n\nÎnvierea nu este formulată în psalm prin propoziția «Mesia va învia în ziua a treia», dar trecerea de la suferindul amenințat de moarte la Cel care vestește Numele în adunare este citită de Evrei în lumina lui Hristos viu. Aceasta este o lectură canonică, nu o deducție izolată dintr-un singur verb.",
      source: {
        kind: "poonen",
        transcript,
        anchor: "there's a resurrection there ... verse 22 ... quoted in Hebrews ... result of the cross ... praise ... worship ... serve him",
      },
      explanationKind: "exposition",
      forYourHeart:
        "Crucea nu produce numai oameni ocupați în slujire; produce oameni care Îl laudă, se închină și apoi slujesc din ceea ce au văzut.",
    },
  ],
}

const PSALMUL_32: ExplainedOverlayChapter = {
  number: 32,
  title: "Psalmul 32 — Păcat iertat și acoperit, mărturisire și o distincție de legământ care trebuie formulată atent",
  summary:
    "David declară fericirea omului a cărui fărădelege este iertată și al cărui păcat este acoperit, descrie uscăciunea tăcerii, mărturisirea care nu mai ascunde vina și călăuzirea lui Dumnezeu după iertare. Zac Poonen folosește «acoperit» pentru a contrasta Vechiul Legământ cu curățirea deplină prin sângele lui Isus și spune absolut că în Vechiul Legământ nu exista curățire. Intenția lui de a sublinia superioritatea jertfei lui Hristos este biblică; formularea absolută trebuie însă limitată, deoarece Vechiul Testament folosește el însuși limbaj real de curățire și iertare, iar Evrei precizează în ce sens jertfele vechi nu puteau desăvârși conștiința și îndepărta definitiv păcatul.",
  units: [
    {
      from: 1,
      to: 5,
      heading: "«Iertat» și «acoperit» sunt bucuria psalmului, nu o afirmație că Dumnezeu doar ascunde vina fără să ierte",
      teaching:
        "Psalmul începe cu paralelism: fericit este omul a cărui fărădelege este `nasa` — ridicată/iertată — și al cărui păcat este `kasah` — acoperit. Apoi spune că DOMNUL nu-i mai socotește nelegiuirea. Sensul imediat este iertarea reală, nu o contabilitate în care vina rămâne juridic neatinsă dar este doar ascunsă vizual.\n\nPoonen spune: în Vechiul Legământ era «forgiveness and covering», nu «cleansing»; curățirea vine după moartea lui Isus, iar sângele animalelor putea doar acoperi. El încearcă să exprime superioritatea Noului Legământ și a sângelui lui Hristos, idee puternic susținută de Evrei 9–10. Dar forma «there's no cleansing of sin in the Old Covenant» este prea absolută dacă este tratată lexical sau canonic.\n\nLevitic 16:30 spune în Ziua Ispășirii că se face ispășire «ca să vă curățească; veți fi curățiți de toate păcatele voastre înaintea DOMNULUI». Psalmul 51 cere «curățește-mă de păcatul meu». Ezechiel folosește de asemenea limbajul curățirii. Așadar Vechiul Testament poate vorbi real despre curățire în cadrul legământului său.\n\nDistincția Noului Testament este mai precisă: sângele taurilor și țapilor nu poate lua definitiv păcatele, jertfele repetate nu pot desăvârși conștiința în modul final, iar Hristos intră o dată pentru totdeauna și obține o răscumpărare veșnică. Superioritatea Crucii nu are nevoie să negăm vocabularul de curățire pe care Dumnezeu Însuși l-a folosit înainte de Cruce.\n\nAstfel păstrăm mesajul lui Poonen — nu te întoarce la umbra jertfelor când realitatea a venit în Hristos — dar îl formulăm în termenii pe care Evrei îi folosește.",
      source: {
        kind: "canonical-exegesis",
        sources: ["Psalmul 32:1-5", "Leviticul 16:30", "Psalmul 51:2,7", "Evrei 9:9-14", "Evrei 10:1-18", "Zac Poonen — Through The Bible: Psalms"],
        note: "Corectează absolutizarea «no cleansing under old covenant» păstrând contrastul Poonen despre finalitatea jertfei lui Hristos.",
      },
      explanationKind: "exposition",
      words: [
        {
          original: "נְשׂוּי־פֶּשַׁע",
          transliteration: "nesui-pesha",
          language: "ebraica",
          meaning: "a cărui fărădelege este ridicată/iertată",
          verseRef: "Psalmul 32:1",
          lexicalSource: "WLC-OSHB",
        },
        {
          original: "כְּסוּי חֲטָאָה",
          transliteration: "kesui hata'ah",
          language: "ebraica",
          meaning: "al cărui păcat este acoperit",
          verseRef: "Psalmul 32:1",
          lexicalSource: "WLC-OSHB",
        },
      ],
      forYourHeart:
        "Nu ai nevoie să micșorezi harul din Vechiul Testament ca să mărești Crucea. Crucea este mai mare tocmai fiindcă duce la împlinire ceea ce jertfele și iertarea vechiului legământ anticipau.",
    },
    {
      from: 6,
      to: 11,
      heading: "După mărturisire, Dumnezeu nu doar iartă; călăuzește omul care nu mai vrea să fie încăpățânat",
      teaching:
        "Psalmul trece de la iertare la rugăciune, refugiu și călăuzire. Dumnezeu spune: «te voi învăța și îți voi arăta calea pe care trebuie să mergi; te voi sfătui cu ochiul asupra ta».\n\nPoonen evidențiază această ordine: după ce păcatul este recunoscut și iertat, omul nu trebuie să revină la încăpățânarea catârului, ci să se lase condus. Iertarea nu este permisiune de a continua același drum cu o factură anulată periodic.\n\nFinalul contrastează durerile celui rău cu bunătatea care îl înconjoară pe cel ce se încrede în DOMNUL și cheamă pe cei drepți la bucurie. Bucuria iertării produce o viață orientată spre ascultare, nu autosuficiență.",
      source: {
        kind: "poonen",
        transcript,
        anchor: "Psalm 32 ... when I acknowledged my sin I was forgiven ... I will instruct you and teach you ... don't be stubborn anymore",
      },
      explanationKind: "exposition",
    },
  ],
...
const PSALMUL_51: ExplainedOverlayChapter = {
  number: 51,
  ...
  units: [
    ...
    },
    {
      ...
      source: {
        kind: "canonical-exegesis",
        sources: ["Psalmul 51:13-19", "2 Samuel 12:13", "1 Ioan 1:7-9"],
