...
const REVIEWED_2_19_25: ExplainedOverlayUnit = {
  ...
  source: {
    ...
    sources: [
      ...
      "WLC-OSHB",
      "Luca 9:51-56",
      "Zac Poonen — Through The Bible: 2 Kings, contrastul Ilie / duhul Noului Legământ",
    ],
    note: "Poonen nu dezvoltă episodul urșilor; explicația păstrează judecata textului și folosește Poonen numai pentru contrastul explicit al Noului Legământ.",
  },
