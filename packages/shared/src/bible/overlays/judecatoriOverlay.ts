...
const focused: Record<number, ExplainedOverlayChapter> = {
  ...
  5: {
    ...
    units: [
      {
        from: 1, to: 5,
        heading: "Cântarea începe cu binecuvântarea DOMNULUI",
        teaching: "Debora și Barac deschid cântarea atribuind biruința DOMNULUI și binecuvântând disponibilitatea conducătorilor și a poporului. Imaginile despre Seir, Edom, pământul care se cutremură și norii care varsă apă așază lupta recentă într-un cadru mai larg al venirii lui Dumnezeu pentru poporul Său.",
        source: n,
      },
      {
        from: 6, to: 11,
        heading: "Drumuri părăsite, sate golite și o generație care trebuia trezită",
        teaching: "Cântarea descrie starea de nesiguranță dinaintea izbăvirii: drumurile erau părăsite, călătorii mergeau pe căi ocolite și viața satelor se stingea. Debora își descrie ridicarea în această criză, iar apoi sunt chemați să povestească faptele drepte ale DOMNULUI la locurile unde din nou se poate auzi glasul oamenilor.",
        source: n,
      },
      {
        from: 12, to: 18,
        heading: "Unii coboară la luptă, alții rămân între staule sau lângă corăbii",
        teaching: "Cântarea îi cheamă pe Debora și Barac la trezire și apoi trece în revistă răspunsul semințiilor. Efraim, Beniamin, Machir, Zabulon și Isahar sunt legați de mobilizare, în timp ce Ruben este descris în mari frământări fără a părăsi staulele, iar Galaad, Dan și Așer rămân în zonele lor. Textul păstrează memoria acestor răspunsuri diferite la aceeași criză.",
        source: n,
      },
      {
        from: 19, to: 23,
        heading: "Bătălia de la Taanac, pârâul Chison și blestemul asupra Merozului",
        teaching: "Regii Canaanului sunt descriși luptând la Taanac, iar poezia spune că stelele și pârâul Chison au luptat împotriva lor. Merozul este apoi blestemat pentru că nu a venit în ajutor în această luptă. Aceste versuri aparțin cântării de război a Israelului din epocă și nu constituie un mandat pentru violență religioasă modernă.",
        source: n,
      },
      {
        from: 24, to: 27,
        heading: "Iael și moartea lui Sisera",
        teaching: "Cântarea o numește binecuvântată pe Iael și reia poetic scena morții lui Sisera: laptele oferit, țărușul și lovitura fatală. Relatarea celebrează înfrângerea comandantului armatei asupritoare în cadrul războiului din Judecători; Emanus nu transferă metoda acestei narațiuni în etica relațiilor personale sau a conflictelor contemporane.",
        source: n,
      },
      {
        from: 28, to: 31,
        heading: "Mama lui Sisera așteaptă un car care nu se mai întoarce",
        teaching: "Ultima strofă schimbă perspectiva spre casa lui Sisera, unde mama lui așteaptă la fereastră și își explică întârzierea prin presupusa împărțire a prăzii. Cântarea se încheie cerând ca vrăjmașii DOMNULUI să piară și cei ce Îl iubesc să fie ca soarele când se ridică în puterea lui, după care țara are odihnă patruzeci de ani.",
        source: n,
      },
    ],
  },
  ...
  9: {
    ...
    units: [
      {
        from: 1, to: 6,
        heading: "Șaptezeci de sicli, oameni de nimic și șaptezeci de frați uciși",
        teaching: "Abimelec merge la familia mamei lui din Sihem și transformă legătura de rudenie în argument pentru putere. Cu argint luat din casa lui Baal-Berit își angajează oameni, își ucide frații pe aceeași piatră și este proclamat împărat. Iotam, cel mai tânăr, scapă și rămâne singurul dintre frați care poate vorbi împotriva acestei instaurări.",
        source: n,
      },
      {
        from: 7, to: 21,
        heading: "Pilda copacilor: spinul acceptă coroana pe care pomii roditori o refuză",
      ...
      {
        from: 22, to: 29,
        heading: "Relația dintre Abimelec și Sihem începe să se destrame",
        teaching: "După trei ani, ostilitatea se instalează între Abimelec și conducătorii Sihemului. Oamenii cetății pun pândă pe drumuri, iar Gaal, fiul lui Ebed, câștigă încrederea lor și îl provoacă public pe Abimelec. Narațiunea urmărește cum alianța făcută prin sânge și interes începe să se întoarcă împotriva propriilor participanți.",
        source: n,
      },
      {
        from: 30, to: 41,
        heading: "Zebul îl avertizează pe Abimelec, iar Gaal este alungat",
        teaching: "Zebul, conducătorul cetății, află cuvintele lui Gaal și trimite în ascuns lui Abimelec planul pentru atac. Dimineața, Gaal vede trupele coborând de pe munți, este împins de Zebul să-și susțină lauda și iese la luptă. Abimelec îl învinge, iar Gaal și oamenii lui sunt izgoniți din Sihem.",
        source: n,
      },
      {
        from: 42, to: 49,
        heading: "Sihemul este distrus, iar turnul este ars peste cei refugiați în el",
        teaching: "Conflictul nu se oprește la alungarea lui Gaal. Abimelec atacă oamenii ieșiți la câmp, cucerește cetatea și o distruge. Cei care se refugiază în turnul Sihemului sunt încercuiți, iar Abimelec folosește ramuri pentru a-i da foc. Narațiunea descrie escaladarea brutală a luptei pentru putere; nu oferă un model legitim de pedepsire colectivă.",
        source: n,
      },
      {
        from: 50, to: 57,
        heading: "La Tebeț, o piatră de moară pune capăt domniei lui Abimelec",
        teaching: "Abimelec repetă la Tebeț tactica folosită la Sihem, dar o femeie aruncă de pe turn o piatră de moară care îi zdrobește capul. El îi cere purtătorului de arme să-l omoare ca să nu se spună că a murit de mâna unei femei. Finalul capitolului interpretează căderea lui Abimelec și a Sihemului ca întoarcere asupra lor a răului făcut casei lui Ghedeon și a blestemului rostit de Iotam.",
        source: n,
      },
    ],
  },
  10: {
    ...
    units: [
      {
        from: 1, to: 5,
        heading: "Tola și Iair judecă Israelul între marile crize ale cărții",
        teaching: "Tola este ridicat după Abimelec și judecă Israelul douăzeci și trei de ani. După el vine Iair, descris prin cei treizeci de fii și cetățile lor, și judecă douăzeci și doi de ani. Narațiunea le acordă puține detalii, dar îi așază ca perioade reale de conducere între crizele mai amplu povestite.",
        source: n,
      },
      {
        from: 6, to: 9,
        heading: "Israel slujește unei mulțimi de dumnezei și este zdrobit din două direcții",
        teaching: "Textul enumeră Baalii, Astarteile și dumnezeii mai multor popoare vecine pentru a arăta întinderea noii apostazii. Israel părăsește pe DOMNUL, iar filistenii și amoniții ajung să-l apese. Galaadul este lovit direct, apoi amenințarea trece Iordanul spre Iuda, Beniamin și Efraim.",
        source: n,
      },
      {
        from: 10, to: 16,
        heading: "Mărturisirea păcatului este urmată de îndepărtarea dumnezeilor străini",
        teaching: "Copiii lui Israel mărturisesc că au păcătuit părăsind pe Dumnezeu. Răspunsul amintește izbăvirile anterioare și confruntă contradicția de a reveni la DOMNUL numai când dumnezeii aleși nu îi pot salva. Poporul spune apoi că acceptă disciplina, îndepărtează dumnezeii străini și slujește DOMNULUI; textul încheie această secțiune spunând că suferința lui Israel nu Îi este indiferentă.",
        source: n,
      },
      {
        from: 17, to: 18,
        heading: "Amon se strânge la Galaad, iar cetățile caută un conducător",
        teaching: "Amoniții se adună în Galaad, iar Israel își așază tabăra la Mițpa. Conducătorii din Galaad ajung la întrebarea practică ce deschide capitolul următor: cine va începe lupta cu Amon și va deveni căpetenie peste locuitorii Galaadului?
",
        source: n,
      },
    ],
  ...
  11: {
    ...
    units: [
      {
        from: 1, to: 11,
        heading: "Cel alungat de familie este chemat când Galaadul are nevoie de un războinic",
        teaching: "Iefta este prezentat ca viteaz, dar și ca fiu al unei femei marginalizate, alungat de frații lui din moștenire. El trăiește în țara Tob până când bătrânii Galaadului vin să-i ceară ajutor împotriva lui Amon. Iefta le amintește că l-au urât și izgonit, iar întoarcerea lui este negociată până când este pus căpetenie și conducător.",
        source: n,
      },
      {
        from: 12, to: 28,
        heading: "Înaintea luptei, Iefta răspunde pretenției teritoriale prin istoria Exodului",
        teaching: "Iefta trimite mai întâi soli împăratului amoniților și întreabă motivul atacului. Când primește revendicarea asupra teritoriului, el răspunde recapitulând traseul Israelului, refuzurile Edomului și Moabului și conflictul cu Sihon. Argumentul lui este că Israel nu luase țara lui Moab sau Amon în drumul său, iar disputa nu fusese ridicată în secolele anterioare. Împăratul amoniților nu primește răspunsul.",
        source: n,
      },
      {
        from: 29, to: 33,
        heading: "Duhul DOMNULUI vine peste Iefta, iar el rostește un jurământ înaintea victoriei",
        teaching: "Textul spune că Duhul DOMNULUI vine peste Iefta și descrie traseul lui spre luptă. Înaintea confruntării, Iefta rostește un jurământ despre ceea ce va ieși din casa lui când se va întoarce în pace. Victoria asupra amoniților este apoi relatată separat, cu cetățile lovite și supunerea lor înaintea lui Israel.",
        source: n,
      },
      {
        from: 34, to: 40,
        heading: "Fiica lui Iefta iese în întâmpinare, iar jurământul transformă victoria în jale",
        teaching: "Când Iefta se întoarce, singurul lui copil, fiica sa, îi iese înainte cu timpane și jocuri. Bucuria se transformă imediat în durere din cauza jurământului rostit. Ea cere timp să-și plângă fecioria împreună cu prietenele, iar narațiunea spune că Iefta împlinește jurământul făcut. Capitolul nu prezintă jurământul ca poruncă dată de Dumnezeu și nu îl transformă într-un model pentru promisiuni primejdioase sau vătămarea unei persoane.",
        source: n,
      },
    ],
  },
  12: {
    ...
    units: [
      {
        from: 1, to: 7,
        heading: "O ceartă între seminții ajunge la luptă și la testul «Șibolet»",
        teaching: "Bărbații lui Efraim îl acuză pe Iefta că nu i-a chemat la luptă și îl amenință. Iefta răspunde că îi chemase fără să primească ajutor, iar conflictul escaladează într-o luptă internă. La vadurile Iordanului, pronunția cuvântului «Șibolet» este folosită pentru identificarea efraimiților fugari, iar textul consemnează pierderi foarte mari. Episodul descrie destrămarea internă a Israelului, nu un model pentru persecutarea oamenilor după limbă sau origine.",
        source: n,
      },
      {
        from: 8, to: 15,
        heading: "Ibțan, Elon și Abdon închid seria de judecători de după Iefta",
        teaching: "După moartea lui Iefta, narațiunea îi prezintă pe Ibțan din Betleem, Elon din Zabulon și Abdon din Piraton. Detaliile sunt scurte și pun accent pe durata judecării și pe familiile lor. Aceste tranziții duc cartea spre ciclul lui Samson, fără a descrie o nouă mare izbăvire în aceste versete.",
        source: n,
      },
    ],
  },
  ...
  15: {
    ...
    units: [
      {
        from: 1, to: 8,
        heading: "O relație ruptă ajunge la incendiere și represalii succesive",
        teaching: "Samson află că soția lui fusese dată altui bărbat și răspunde printr-o acțiune care incendiază recoltele filistenilor. Filistenii răspund prin uciderea femeii și a tatălui ei, iar Samson răspunde din nou printr-o lovitură asupra lor. Textul prezintă un lanț de răzbunări care se amplifică; nu îl oferă ca procedură legitimă pentru conflicte personale.",
        source: n,
      },
      {
        from: 9, to: 13,
        heading: "Trei mii de oameni din Iuda îl leagă pe Samson ca să-l predea",
        teaching: "Filistenii urcă în Iuda ca să-l prindă pe Samson, iar oamenii din Iuda vin în număr mare la stânca Etam. Ei îi spun că filistenii stăpânesc peste ei și cer să-l lege pentru a-l preda. Samson acceptă să fie legat după ce primește asigurarea că oamenii lui nu îl vor omorî ei înșiși.",
        source: n,
      },
      {
        from: 14, to: 17,
        heading: "Funia se rupe, iar falca de măgar devine arma luptei",
        teaching: "Când Samson ajunge la filisteni, textul spune că Duhul DOMNULUI vine peste el, legăturile cedează și el folosește o falcă de măgar pentru a-i lovi. Numele locului păstrează memoria episodului. Acțiunea aparține conflictului militar din Judecători și nu este un model pentru violență personală.",
        source: n,
      },
      {
        from: 18, to: 20,
        heading: "După victorie, Samson ajunge la limită și cere apă",
        teaching: "Puterea din luptă nu îl face pe Samson independent de nevoile trupului. Chinuit de sete, el strigă către DOMNUL și recunoaște izbăvirea primită, temându-se că va muri și va cădea în mâinile filistenilor. Dumnezeu deschide o sursă de apă, iar narațiunea notează apoi că Samson a judecat Israelul douăzeci de ani în vremea filistenilor.",
        source: n,
      },
    ],
  },
  ...
  17: {
    ...
    units: [
      {
        from: 1, to: 6,
        heading: "Argintul furat se întoarce în casă și ajunge chip pentru sanctuarul lui Mica",
        teaching: "Mica mărturisește că luase argintul mamei sale și îl restituie. Mama consacră o parte din argint pentru un chip, iar Mica ajunge să aibă o casă de dumnezei, un efod, terafimi și un fiu pus preot. Versetul 6 oferă cadrul editorial al secțiunii: nu era împărat în Israel și fiecare făcea ce era drept în propriii ochi.",
        source: n,
      },
      {
        from: 7, to: 13,
        heading: "Levitul caută un loc, iar Mica îl angajează ca preot personal",
        teaching: "Un tânăr levit din Betleem pleacă să caute unde să locuiască și ajunge la casa lui Mica. Mica îi oferă hrană, îmbrăcăminte și plată ca să-i fie preot. Finalul arată încrederea lui Mica în această aranjare: el presupune că DOMNUL îi va face bine pentru că are un levit ca preot, deși întregul sanctuar fusese organizat după inițiativa casei lui.",
        source: n,
      },
    ],
  },
  18: {
    ...
    units: [
      {
        from: 1, to: 6,
        heading: "Cinci iscoade caută o moștenire și consultă preotul lui Mica",
        teaching: "Capitolul reia refrenul că nu era împărat în Israel și explică faptul că daniții încă își căutau o moștenire în care să se așeze. Cinci oameni sunt trimiși să cerceteze țara, recunosc glasul levitului în casa lui Mica și îi cer să întrebe dacă drumul lor va izbuti. Levitul le oferă un răspuns favorabil.",
        source: n,
      },
      {
        from: 7, to: 13,
        heading: "Laișul este găsit liniștit și izolat, iar iscoadele cer acțiune imediată",
        teaching: "Iscoadele ajung la Laiș și observă o cetate liniștită, fără legături puternice cu vecinii care ar putea veni repede în ajutor. Întorși la frații lor, ei descriu țara drept foarte bună și îi îndeamnă să nu întârzie. Șase sute de oameni înarmați pornesc apoi spre nord.",
        source: n,
      },
      {
        from: 14, to: 26,
        heading: "Daniții iau efodul, terafimii și chipul și îl conving pe levit să plece cu ei",
        teaching: "Cei cinci iscoade îi conduc pe oamenii înarmați la casa lui Mica și iau obiectele de cult. Când levitul întreabă ce fac, ei îi oferă un rol mai mare: să fie preotul unei seminții, nu doar al unei familii. Levitul acceptă. Mica îi urmărește și protestează că i-au luat dumnezeii și preotul, dar se întoarce când vede că grupul este mai puternic decât el.",
        source: n,
      },
      {
        from: 27, to: 31,
        heading: "Laișul este cucerit și numit Dan, iar chipul lui Mica devine cult al seminției",
        teaching: "Daniții atacă Laișul, ard cetatea și o reconstruiesc sub numele Dan. Acolo așază chipul luat de la Mica și stabilesc o linie de preoți. Ultimul verset pune acest sanctuar în contrast temporal cu Casa lui Dumnezeu de la Șilo, arătând că aranjamentul religios al lui Mica nu a rămas o excentricitate privată, ci s-a extins la nivelul unei seminții.",
        source: n,
      },
    ],
  },
  19: {
    ...
    units: [
      {
        from: 1, to: 10,
        heading: "Levitul merge să-și aducă înapoi concubina și este întârziat de tatăl ei",
        teaching: "Narațiunea prezintă un levit din muntele lui Efraim a cărui concubină ajunsese în casa tatălui ei la Betleem. El merge să vorbească inimii ei și să o aducă înapoi. Tatăl femeii îl primește cu bucurie și îl reține mai multe zile prin ospitalitate, până când levitul insistă să pornească la drum spre seară.",
        source: n,
      },
      {
        from: 11, to: 15,
        heading: "Călătorii trec de Iebus și aleg Ghibea, o cetate a lui Beniamin",
        teaching: "Slujitorul propune să rămână la Iebus, dar levitul preferă să ajungă într-o cetate a copiilor lui Israel. Ei ajung la Ghibea după apus și se așază în piață, însă nimeni nu îi primește inițial în casă. Alegerea unei cetăți israelite nu îi protejează de răul care urmează.",
        source: n,
      },
      {
        from: 16, to: 21,
        heading: "Un bătrân străin de cetate îi primește în casa lui",
        teaching: "Un bătrân care se întorcea de la muncă află că levitul este din muntele lui Efraim, ca și el, și îi avertizează să nu rămână în piață. Îi primește în casă, le îngrijește animalele și le oferă hrană. Această ospitalitate formează contrastul imediat cu violența oamenilor care înconjoară casa.",
        source: n,
      },
      {
        from: 22, to: 26,
        heading: "Mulțimea cere bărbatul, iar concubina este dată afară și abuzată până dimineața",
        teaching: "Oameni ai cetății înconjoară casa și cer ca levitul să fie scos la ei pentru a-l viola. Gazda încearcă să împiedice atacul, dar propune la rândul lui expunerea femeilor din casă. În cele din urmă concubina este scoasă, este abuzată sexual toată noaptea și cade dimineața la ușă. Narațiunea expune o prăbușire morală extremă; violența sexuală și sacrificarea unei victime pentru salvarea altora nu sunt aprobate prin simplul fapt că sunt relatate.",
        source: n,
      },
      {
        from: 27, to: 30,
        heading: "Trupul femeii este trimis în Israel ca semn al atrocității",
        teaching: "Dimineața, levitul găsește femeia la prag, o pune pe măgar și se întoarce acasă. Apoi îi taie trupul și trimite bucățile în teritoriile lui Israel, provocând o reacție națională de groază și chemarea de a lua în considerare ce trebuie făcut. Gestul lui face parte din escaladarea întunecată a finalului cărții și nu este o practică legitimă de mobilizare sau tratare a unui trup omenesc.",
        source: n,
      },
    ],
  },
  20: {
    ...
    units: [
      {
        from: 1, to: 7,
        heading: "Adunarea de la Mițpa ascultă relatarea levitului",
        teaching: "Semințiile se adună ca un singur om și cer să afle cum s-a petrecut nelegiuirea. Levitul relatează sosirea la Ghibea, atacul asupra lui și moartea concubinei, apoi explică trimiterea trupului în Israel. Adunarea primește astfel cazul care va declanșa acțiunea colectivă.",
        source: n,
      },
      {
        from: 8, to: 17,
        heading: "Israel cere predarea oamenilor din Ghibea, dar Beniamin se mobilizează pentru război",
        teaching: "Adunarea hotărăște să acționeze împotriva Ghibei și trimite soli prin seminția lui Beniamin cerând predarea oamenilor vinovați. Beniamin refuză să asculte și își strânge luptătorii, inclusiv șapte sute de oameni aleși descriși prin precizia praștiei lor. Ceea ce începe ca judecarea unei crime locale devine astfel conflict între seminții.",
        source: n,
      },
      {
        from: 18, to: 28,
        heading: "Două înfrângeri îi duc pe israeliți la plâns, post și o nouă întrebare înaintea DOMNULUI",
        teaching: "Israel întreabă cine să urce primul și primește răspunsul «Iuda», dar este înfrânt în prima zi. După încurajare și o nouă întrebare, este înfrânt din nou. Abia după a doua înfrângere întreaga adunare plânge, postește și aduce jertfe, iar textul îl menționează pe Fineas înaintea chivotului. Răspunsul pentru a treia zi anunță că Beniamin va fi dat în mâna lor.",
        source: n,
      },
      {
        from: 29, to: 36,
        heading: "Ambuscada întoarce a treia bătălie împotriva lui Beniamin",
        teaching: "Israel așază oameni la pândă în jurul Ghibei și repetă aparent retragerea din zilele precedente. Beniamiții ies din cetate și cred că îi înving din nou, dar sunt atrași departe de Ghibea. Semnalul fumului și atacul ambuscadei schimbă cursul luptei, iar Beniamin își dă seama că dezastrul a ajuns asupra lui.",
        source: n,
      },
      {
        from: 37, to: 48,
        heading: "Victoria se transformă într-o distrugere aproape totală a lui Beniamin",
        teaching: "Oamenii din pândă intră în Ghibea și îi dau foc, iar forțele lui Beniamin sunt lovite din mai multe direcții. Doar șase sute de bărbați ajung la stânca Rimon. Finalul descrie Israelul întorcându-se asupra cetăților lui Beniamin și trecând prin sabie oameni, animale și localități. Textul pregătește criza din capitolul 21: pedepsirea crimei a ajuns la marginea dispariției unei seminții. Devastarea este relatată istoric, nu prescrisă comunității creștine.",
        source: n,
      },
    ],
  },
  21: {
    ...
    units: [
      {
        from: 1, to: 7,
        heading: "Jurământul făcut la Mițpa creează o nouă criză după război",
        teaching: "Israel jurase să nu dea nicio fiică de soție unui beniamit. După devastarea seminției, poporul plânge înaintea lui Dumnezeu și întreabă de ce lipsește o seminție din Israel. Totuși jurământul lor rămâne în picioare, astfel încât problema supraviețuirii lui Beniamin este agravată chiar de propria hotărâre colectivă.",
        source: n,
      },
      {
        from: 8, to: 15,
        heading: "Iabeș-Galaad este atacat pentru absența de la adunare, iar patru sute de fete sunt date beniaminților",
      ...
      {
        from: 16, to: 24,
        heading: "Pentru bărbații rămași fără soții, bătrânii propun răpirea fetelor de la Șilo",
        teaching: "Cum cele patru sute de femei nu sunt suficiente, bătrânii caută o cale de a păstra jurământul fără ca Beniamin să dispară. Ei îi instruiesc pe bărbații rămași să se ascundă lângă sărbătoarea de la Șilo și să ia fete dintre cele care ies la joc. Planul evită formal ca părinții să le «dea» fiicele, dar o face prin constrângerea femeilor. Narațiunea arată o soluție omenească profund tulburătoare într-o epocă dezordonată; răpirea nu devine legitimă pentru că apare în text.",
        source: n,
      },
      {
        from: 25, to: 25,
        heading: "Ultimul verset explică atmosfera întregului final al cărții",
        teaching: "Judecători se încheie repetând: nu era împărat în Israel și fiecare făcea ce era drept în propriii ochi. Refrenul nu transformă automat fiecare acțiune anterioară într-o poruncă divină; dimpotrivă, este cadrul literar în care cartea a relatat idolatria, abuzul, războiul între frați și soluțiile morale contradictorii ale ultimelor capitole.",
        source: n,
      },
    ],
  },
