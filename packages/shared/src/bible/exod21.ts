  ...
  units: [
    {
      ...
      teaching: teaching(
        ...
        "Sunt aici și cuvinte grele, la care nu se cade să îndulcim nimic: dacă stăpânul i-a dat femeie, femeia și copiii rămân ai stăpânului. Nu scrie că lucrul acesta este bun. Legea aceasta nu ne arată lumea așa cum a voit-o Dumnezeu la început; ea așează hotare într-o lume căzută. Domnul Iisus va spune în alt loc că unele rânduieli au fost date „pentru împătrirea inimii” oamenilor — și tocmai de aceea nu se poate lua orice rânduială de aici ca măsură a desăvârșirii.",
      ...
      words: [
        {
          ...
          language: "ebraica",
          meaning:
            "rânduieli, hotărâri de judecată. Cele zece cuvinte se rostesc din foc; acestea coboară în curte și în og-radă.",
        },
        {
        ...
        },
        {
          ...
          transliteration: "veraaț et azno",
          language: "ebraica",
          meaning:
    ...
    },
    {
      ...
      teaching: teaching(
        "Urmează rânduiala despre fata vândută de tatăl ei ca slujnică. Este printre locurile cele mai grele din carte, și nu se cade îmblânzit. În sărăcia din vremea aceea, un părinte împins la capăt Își putea da copilul într-o altă casă. Legea nu laudă lucrul acesta: îl gasește făcut și pune un zid în jurul celei mai neapărate dintre toți.",
        "Și ia aminte ce spune: ea nu iese cum ies robii, adică nu poate fi zvârlită afară când nu mai place. Dacă stăpânul nu o mai vrea, nu are dreptul să o vandă la străini. Dacă a fost dată fiului, să fie ținută ca o fiică. Iar dacă stăpânul Își ia altă femeie, celei dintâi nu are voie să-i taie trei lucruri: hrana, îmbrăcămintea și dreptul ei de soție.",
        "Se cade zăbovit asupra celor trei. Nu se vorbește doar de pâine și haine: al treilea lucru este dreptul ei de a nu fi lăsată singură și nebagată în seamă în casa în care trăiește. În lumea veche, o femeie lăsată fără acest drept era o nimică. Dumnezeu Îl scrie în lege. Ia aminte că Dumnezeu apără nu numai viața, ci și cinstea, și chiar dragostea datorată cuiva.",
        "Și vezi încheierea: dacă nu-i dă aceste trei lucruri, ea iese slobodă, fără plată. Cine nu Își împ linete datoria față de omul din casa lui pierde dreptul asupra lui. Înaintea lui Dumnezeu, stăpânirea nu se ține cu puterea, ci cu grija.",
      ),
      words: [
        {
          original: "לאמה",
          ...
          language: "ebraica",
          meaning:
            "ca slujnică. Legea nu laudă lucrul acesta: îl gasește făcut și pune un zid în jurul celei mai neapărate.",
        },
        {
        ...
        },
        {
          ...
          transliteration: "veiața hinam ein kasef",
          language: "ebraica",
          meaning:
      ...
      words: [
        {
          ...
          language: "ebraica",
          meaning:
            "nu a stătut la pândă, nu a făcut-o cu gând. Nu se cântărește numai fapta, ci și gândul din care a ieșit.",
        },
        {
    ...
    },
    {
      ...
      teaching: teaching(
        "Dacă doi se cearta și unul rămâne la pat, cel care a lovit plătește zilele pierdute și vindecarea. Ia aminte ce fel de dreptate este aceasta: nu se încheie cu o pedeapsă, ci cu o îndreptare. Cel vătămat nu primește răzbunare, ci ce a pierdut. Dumnezeu nu Se îndestulează cu vinovatul pedepsit; vrea pe cel lovit ridicat.",
        ...
        "La mijloc stă pricina femeii însărcinate lovite în încaierare, și apoi cuvintele cele mai cunoscute și cele mai rău înțelese: viață pentru viață, ochi pentru ochi, dinte pentru dinte. Ia aminte că nu sunt o îngăduire a răzbunării, ci hotarul ei: atât, și nici un pas mai mult. Fără legea aceasta, un ochi scos cere în lumea oamenilor o casă arsa. Iar Domnul Iisus nu a stricat măsura aceasta: a arătat că ucenicul Lui nu Își mai ia nici măcar ce i se cuvine.",
    ...
    },
    {
      ...
      teaching: teaching(
        ...
        "Și ia aminte că Dumnezeu Se coboară în lucruri atât de mici: un bou, un măgar, o groapă într-o og-radă. Cel care a vorbit din foc pe muntele care fumega vorbește acum despre paguba unui vecin. Nu este niciun lucru al vieții noastre prea mărunt pentru sfințenia Lui.",
      ...
      words: [
        {
          ...
          language: "ebraica",
          meaning:
            "groapă, put. Răspundem și pentru ce am lăsat deschis, nu doar pentru ce am făcut cu mâna.",
        },
        {
          original: "ולא יכסנו",
