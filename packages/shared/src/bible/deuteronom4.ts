...
export const DEUTERONOM_4 = deuteronomChapter({
  ...
  units: [
    ...
    },
    {
      ...
      forYourHeart:
        "Nici cea mai grea consecință a păcatului tău nu este mai mare decît mila lui Dumnezeu pentru cel care Îl caută cu toată inima.",
    },
    {
