...
/*
 * Geneza 22, explicata verset cu verset.
 * Text: Cornilescu 1924, editia originala. Explicatia: scrisa pentru Emanus.
 */

export const GENEZA_22: BibleChapter = {
  id: "geneza-22",
  bookId: "geneza",
  number: 22,
  ...
  historicalContext:
    "Tara Moria este numita mai tarziu locul unde Solomon a zidit Casa Domnului, la Ierusalim; drumul de la Beer-Seba pana acolo tine intr-adevar cam trei zile de mers. In lumea canaanita din jur, jertfirea copiilor era o practica a inchinarii la idoli, si tocmai de aceea Legea data lui Israel o va opri cu cele mai aspre cuvinte, numind-o urata inaintea Domnului. Arderea de tot era jertfa care se mistuia toata, fara sa se opreasca nimic pentru om. Randuiala de mai tarziu cerea ca intaiul nascut sa fie rascumparat cu o jertfa, tocmai fiindca Dumnezeu nu voia viata copilului, ci inima parintelui.",
  status: "in_review",
  units: [
    {
      id: "geneza-22-1-2",
      ref: "Geneza 22:1-2",
      heading: "Ia pe fiul tau, pe singurul tau fiu",
      text:
        "Dupa aceste lucruri, Dumnezeu a pus la incercare pe Avraam, si i-a zis: „Avraame!\" „Iata-ma\", a raspuns el. Dumnezeu i-a zis: „Ia pe fiul tau, pe singurul tau fiu, pe care-l iubesti, pe Isaac; du-te in tara Moria, si adu-l ardere de tot acolo, pe un munte pe care ti-l voi spune.\"",
      teaching:
    ...
    },
    {
      id: "geneza-22-3",
      ref: "Geneza 22:3",
      heading: "S-a sculat dis-de-dimineata",
      text:
    ...
    },
    {
      id: "geneza-22-4-5",
      ref: "Geneza 22:4-5",
      heading: "Si apoi ne vom intoarce la voi",
      text:
        "A treia zi, Avraam a ridicat ochii, si a vazut locul de departe. Si Avraam a zis slugilor sale: „Ramaneti aici cu magarul; eu si baiatul ne vom duce pana colo sa ne inchinam, si apoi ne vom intoarce la voi.\"",
      teaching:
    ...
    },
    {
      id: "geneza-22-6-8",
      ref: "Geneza 22:6-8",
      heading: "Unde este mielul?",
      text:
        "Avraam a luat lemnele pentru arderea de tot, le-a pus in spinarea fiului sau Isaac, si a luat in mana focul si cutitul. Si au mers astfel amandoi impreuna. Atunci Isaac, vorbind cu tatal sau Avraam, a zis: „Tata!\" „Ce este, fiule?\" i-a raspuns el. Isaac a zis din nou: „Iata focul si lemnele; dar unde este mielul pentru arderea de tot?\" „Fiule\", a raspuns Avraam, „Dumnezeu insusi va purta grija de mielul pentru arderea de tot.\" Si au mers amandoi impreuna inainte.",
      teaching:
    ...
    },
    {
      id: "geneza-22-9-10",
      ref: "Geneza 22:9-10",
      heading: "A legat pe fiul sau",
      text:
        "Cand au ajuns la locul pe care i-l spusese Dumnezeu, Avraam a zidit acolo un altar, si a asezat lemnele pe el. A legat pe fiul sau Isaac, si l-a pus pe altar, deasupra lemnelor. Apoi Avraam a intins mana, si a luat cutitul, ca sa junghie pe fiul sau.",
      teaching:
    ...
    },
    {
      id: "geneza-22-11-14",
      ref: "Geneza 22:11-14",
      heading: "Un berbec incurcat in tufis",
      text:
        "Atunci Ingerul Domnului l-a strigat din ceruri, si a zis: „Avraame! Avraame!\" „Iata-ma!\" a raspuns el. Ingerul a zis: „Sa nu pui mana pe baiat, si sa nu-i faci nimic; caci stiu acum ca te temi de Dumnezeu, intrucat n-ai crutat pe fiul tau, pe singurul tau fiu, pentru Mine.\" Avraam a ridicat ochii, si a vazut inapoia lui un berbec, incurcat cu coarnele intr-un tufis; si Avraam s-a dus de a luat berbecul, si l-a adus ca ardere de tot in locul fiului sau. Avraam a pus locului aceluia numele: „Domnul va purta de grija.\" De aceea se zice si azi: „La muntele unde Domnul va purta de grija.\"",
      teaching:
    ...
    },
    {
      id: "geneza-22-15-19",
      ref: "Geneza 22:15-19",
      heading: "Pe Mine insumi jur",
      text:
        "Ingerul Domnului a chemat a doua oara din ceruri pe Avraam, si a zis: „Pe Mine insumi jur, zice Domnul: pentru ca ai facut lucrul acesta, si n-ai crutat pe fiul tau, pe singurul tau fiu, te voi binecuvanta foarte mult si-ti voi inmulti foarte mult samanta, si anume: ca stelele cerului si ca nisipul de pe tarmul marii; si samanta ta va stapani cetatile vrajmasilor ei. Toate neamurile pamantului vor fi binecuvantate in samanta ta, pentru ca ai ascultat de porunca Mea!\" Avraam s-a intors la slugile sale, si s-au sculat si au plecat impreuna la Beer-Seba, caci Avraam locuia la Beer-Seba.",
      teaching:
