/*
 * Textul Evangheliei după Matei, Cornilescu 1924.
...
const MATEI_TEXT: readonly (readonly string[])[] = [
  ...
  [
    ...
    "Căci acolo unde sînt doi sau trei adunaţi în1 (1. Greceşte: Pentru Numele Meu) Numele Meu, sînt şi Eu în mijlocul lor.“",
    ...
    "A început să facă socoteala, şi i-au adus pe unul, care îi datora zece mii de galbeni2 (2. Greceşte: Talanţi.).",
  ...
  [
    ...
    "El a întrebat-o: „Ce vre„Porunceşte“, I-a zis ea, „ca, în Împărăţia Ta aceşti doi fii ai mei să şadă unul la dreapta şi altul la stînga Ta.“",
