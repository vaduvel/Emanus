export const DEUTERONOM_TEXT_25: Record<number, readonly string[]> = {
  25: [
    ...
    "Când frații vor locui împreună și unul din ei va muri fără să aibă fii, nevasta celui mort să nu se mărite afară cu un străin, ci cumnatul ei să intre la ea, s-o ia de nevastă și să împlinească față de ea datoria de cumnat.",
    "Cel dintâi fiu pe care-l va naște ea să poarte numele fratelui mort, pentru ca numele lui să nu fie șters din Israel.",
    "Dacă omul acela nu va voi s-o ia pe cumnata sa, cumnata să se suie la poartă, la bătrâni, și să spună: «Cumnatul meu refuză să ridice fratelui său un nume în Israel, nu vrea să împlinească față de mine datoria de cumnat.»",
    ...
    "Când doi oameni se vor bate împreună, un om și fratele său, și nevasta unuia se apropie să-și scape bărbatul din mâna celui ce-l lovește, dacă va întinde mâna și-l va apuca de părțile rușinoase,",
    "să-i tai mâna; ochiul tău să n-aibă milă de ea.",
    ...
    "Când DOMNUL, Dumnezeul tău, îți va da odihnă de toți vrăjmașii tăi care te înconjoară, în țara pe care ți-o dă DOMNUL, Dumnezeul tău, ca moștenire s-o stăpânești, să ștergi pomenirea lui Amalec de sub cer: să nu uiți!”",
  ],
}
