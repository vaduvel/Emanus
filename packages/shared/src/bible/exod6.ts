...
export const EXOD_6 = exodChapter({
  ...
  units: [
    {
      ...
      teaching: teaching(
        ...
        "Ia aminte la deosebirea din versetul 3: patriarhii Îl cunoscuseră ca Cel Atotputernic, Care făgăduiește; poporul acesta Îl va cunoaște ca Domnul, Care Își împlinete făgăduința în văzul lumii. Nu se spune că Numele era necunoscut, ci că puterea Numelui nu fusese încă văzută. Este cu putință să știi un nume al lui Dumnezeu și să nu-L fi cunoscut încă în felul acela.",
    ...
    },
    {
      ...
      forYourHeart:
        "Erau prea striviti ca să mai poată crede o făgăduință bună — și Dumnezeu i-a scos oricum. Dacă astăzi nu ai putere nici să crezi, El nu Se oprește din pricina asta.",
    },
    {
      verses: [14, 25],
  ...
  prayer:
    "Doamne, Tu ai răspuns la întrebarea amară a lui Moise cu Numele Tău: „Eu sunt Domnul”.\n\nCând nu primim lămurirea pe care o cerem, descoperă-Te Tu Însuți, că este mai mult.\n\nAdu-ți aminte de legământul Tău, căci nu avem alt temei; și împlinete pentru noi făgăduințele în care Tu faci totul.\n\nFii blând cu cei care sunt atât de striviti încât nu mai pot primi nici o veste bună; ușurează-i, și dă-le iarăși suflare. Și învață-ne să nu ne oprim când lucrarea Ta arată la mijloc ca o înfrângere. Amin.",
})
