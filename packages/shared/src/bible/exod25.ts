...
export const EXOD_25 = exodChapter({
  ...
  units: [
    {
      verses: [1, 9],
      heading: "Numai de la cine dă cu inimă bună",
      teaching: teaching(
      ...
      words: [
        {
          ...
          language: "ebraica",
          meaning:
            "dar ridicat, pus deoparte. Nu o dare cerută cu sila, ci ceva ridicat din ce ai și întins spre El.",
        },
        {
          original: "אשר ידבנו לבו",
          transliteration: "așer idvenu libo",
          language: "ebraica",
          meaning:
            "pe care îl îmboldeste inima lui. Dumnezeu nu primește ce se dă din silă sau din rușine.",
        },
        {
          original: "משכן",
          ...
          language: "ebraica",
          meaning:
            "locaș, loc de locuit. Din aceeași rădăcină cu „a locui”: nu un loc de vizită, ci o ședere.",
        },
        {
          original: "ושכנתי בתוכם",
          transliteration: "veșahanti betoham",
          language: "ebraica",
          meaning:
            "și voi locui în mijlocul lor. Pricina întregii lucrări; nu frumusețea, ci apropierea.",
        },
      ],
      crossRefs: ["Ioan 1:14", "2 Corinteni 9:7", "1 Corinteni 6:19", "Exod 35:21-22", "Evrei 8:5"],
      forYourHeart:
        "Dumnezeu nu voia numai să te scoată din Egipt: voia să locuiască cu tine. Ce dai tu cu inimă bună, nu de rușine?",
    },
    {
      verses: [10, 22],
      heading: "Chivotul, capacul ispășirii și locul în care vorbește Dumnezeu",
      teaching: teaching(
        "Cel dintâi lucru poruncit este chivotul: o ladă de lemn de acacia îmbrăcată cu aur pe dinăuntru și pe dinafară. Ia aminte că lemnul rămâne înăuntru, nevăzut, dar nelăsat afară. Nu se cade să facem din fiecare amănunt o taină; dar atât se poate spune cu grijă: în lucrarea lui Dumnezeu, ce este smerit și ce este slăvit stau împreună.",
        "Înăuntru se punea mărturia, adică tablele Legii. Iată ce stă în locul cel mai sfânt al poporului: nu un chip, nu o statuie, ci cuvinte. Iar deasupra se punea capacul de aur curat, cu doi heruvimi, și pe el se stropea, o dată în an, sângele ispășirii. Așa se întâlneau, în același loc, legea care osândește și sângele care acoperă.",
        "Nu se poate trece pe lângă lucrul acesta grăbit. Legea era înăuntru și striga împotriva poporului; sângele era deasupra și sta între Dumnezeu și mărturia aceea. Pavel va scrie că Dumnezeu L-a rânduit pe Domnul Iisus ca ispășire prin sângele Lui — și folosește tocmai cuvântul acestui capac. Ce s-a făcut o dată în an cu sânge de țap S-a făcut o dată pentru totdeauna cu al Lui.",
        "Iar la sfârșit Dumnezeu spune unde va vorbi: acolo Mă voi întâlni cu tine și voi vorbi cu tine de deasupra capacului, dintre cei doi heruvimi. Ia seama: nu de pe vârful muntelui în foc, ci de deasupra locului în care fusese pus sângele. Dumnezeu vorbește de deasupra ispășirii. Cine Îl așteaptă să-i vorbească numai când se va socoti vrednic nu va auzi niciodată nimic; iar cine Îl ascultă de acolo aude îndată.",
      ),
      words: [
        {
          original: "ארון",
          ...
          language: "ebraica",
          meaning:
            "ladă, sicriu. În locul cel mai sfânt nu stă un chip, ci o ladă cu cuvinte scrise.",
        },
        {
          original: "כפרת",
          transliteration: "kaporet",
          language: "ebraica",
          meaning:
            "capacul ispășirii, din rădăcina „a acoperi”. Pavel folosește tocmai cuvântul acesta despre Domnul Iisus.",
        },
        {
          original: "העדת",
          transliteration: "haedut",
          language: "ebraica",
          meaning:
            "mărturia, adică tablele Legii. Legea stă înăuntru și strigă; sângele stă deasupra și acoperă.",
        },
        {
          original: "ונועדתי לך שם",
          transliteration: "venoadeti leha șam",
          language: "ebraica",
          meaning:
            "acolo Mă voi întâlni cu tine. Dumnezeu vorbește de deasupra locului în care s-a pus sângele.",
        },
      ],
      crossRefs: ["Romani 3:25", "Evrei 9:11-14", "Levitic 16:14-16", "Numeri 7:89", "Evrei 4:16"],
      forYourHeart:
        "Dumnezeu vorbește de deasupra ispășirii, nu de pe vârful vredniciei tale. De aceea poți asculta chiar astăzi.",
    },
    {
      verses: [23, 30],
      heading: "O masă la care pâinea stă mereu",
      teaching: teaching(
      ...
      words: [
        {
          original: "שלחן",
          transliteration: "șulhan",
          language: "ebraica",
          meaning:
            "masă. În casa lui Dumnezeu nu este numai altar: este și o masă cu pâine.",
        },
        {
          original: "לחם פנים",
          transliteration: "lehem panim",
          language: "ebraica",
          meaning:
            "pâinea feței, adică pâinea pusă înaintea Lui. Doisprezece pâini: nici o casă nu lipsește.",
        },
        {
          original: "תמיד",
          ...
          language: "ebraica",
          meaning:
            "neîncetat, mereu. Legătura cu Dumnezeu nu atârnă de căldura zilei de astăzi.",
        },
      ],
      crossRefs: ["Levitic 24:5-9", "Matei 12:3-4", "Ioan 6:35", "Psalmi 23:5", "Apocalipsa 3:20"],
      forYourHeart:
        "Sunt zile în care nu simți nimic și nu poți aduce nimic — și pâinea stă tot acolo, fiindcă El a poruncit-o.",
    },
    {
      verses: [31, 40],
      ...
      words: [
        {
          original: "מנרה",
          transliteration: "menora",
          language: "ebraica",
          meaning:
            "candelabru, purtător de lumină. Șapte candele în locul în care nu intra soarele.",
        },
        {
          original: "מקשה",
          transliteration: "mikșa",
          language: "ebraica",
          meaning:
            "lucrare bătută cu ciocanul, dintr-o singură bucată. Nu prin lipire, ci prin lovire.",
        },
        {
          original: "משקדים",
          transliteration: "meșukadim",
          language: "ebraica",
          meaning:
            "în chip de floare de migdal. Migdalul înflorește cel dintâi, când încă nu se vede primăvara.",
        },
        {
          original: "כמראה אשר הראה אתך",
          transliteration: "kamare așer hor'a otha",
          language: "ebraica",
          meaning:
            "după chipul care ți s-a arătat. Închinarea nu se născocește după socotința noastră.",
        },
      ],
      crossRefs: ["Numeri 17:8", "Evrei 8:5", "Levitic 24:1-4", "Zaharia 4:2-6", "Matei 5:14-16"],
      forYourHeart:
        "Ce luminează în casa lui Dumnezeu nu se face prin lipire, ci prin lovire — și se îngrijește în fiecare seară.",
    },
  ],
  prayer:
