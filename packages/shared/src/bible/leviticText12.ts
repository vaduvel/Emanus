...
export const LEVITIC_TEXT_12: Record<number, readonly string[]> = {
  12: Array.from({ length: 8 }, (_, i) => `[Levitic 12:${i + 1}] ${PLACEHOLDER}`),
}
