...
// Lista canonică (cu program și sursă) este comună API-ului și interfeței.
export { CRISIS_RESOURCES } from "./safetyResources.js"
export type { CrisisResource } from "./safetyResources.js"
