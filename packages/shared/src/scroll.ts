...
export const SCROLL_VERSES: ScrollVerse[] = [
  // când te doare
  {
    ...
    ref: "Psalmul 34:18",
    text: "Domnul este aproape de cei cu inima zdrobită și mântuiește pe cei cu duhul înăbușit.",
  ...
  },
  {
    ...
    section: "cand_te_doare",
    ref: "Matei 11:28",
    text: "Veniți la Mine, toți cei trudiți și încărcați, și Eu vă voi da odihnă.",
    axis: "emotional_peace",
  ...
  },
  {
    ...
    section: "cand_te_doare",
    ref: "Psalmul 56:8",
    text: "Tu numări pașii vieții mele de pribeag; pune-mi lacrimile în burduful Tău.",
    axis: "emotional_peace",
  ...
  },
  {
    ...
    section: "cand_esti_speriat",
    ref: "Psalmul 56:3",
    text: "Când mă tem, eu mă încred în Tine.",
    axis: "living_faith",
  ...
  // când te simți vinovat
  {
    ...
    ref: "Romani 8:1",
    text: "Acum dar nu este nici o osândire pentru cei ce sunt în Hristos Isus.",
    axis: "freedom",
  ...
  },
  {
    ...
    section: "cand_te_simti_vinovat",
    ref: "Isaia 1:18",
    text: "De vor fi păcatele voastre ca cârmâzul, se vor face albe ca zăpada.",
    axis: "freedom",
  ...
  // când aștepți
  {
    ...
    ref: "Isaia 40:31",
    text: "Cei ce se încred în Domnul își înnoiesc puterea; ei aleargă și nu obosesc.",
    axis: "living_faith",
  ...
  },
  {
    ...
    section: "cand_astepti",
    ref: "Habacuc 2:3",
    text: "Căci este o prorocie a cărei vreme este hotărâtă… dacă zăbovește, așteaptă-o.",
    axis: "living_faith",
  ...
  },
  {
    ...
    text: "Orice lucru El l-a făcut frumos la vremea lui.",
    axis: "character",
  ...
  },
  {
    ...
    section: "cand_esti_singur",
    ref: "Evrei 13:5",
    text: "Nicidecum nu te voi lăsa și cu nici un chip nu te voi părăsi.",
    axis: "identity",
  ...
  },
  {
    ...
    section: "cand_esti_singur",
    ref: "Isaia 49:16",
    text: "Iată, te-am săpat pe mâinile Mele.",
    axis: "identity",
  ...
  // când mulțumești
  {
    ...
    ref: "Psalmul 103:2",
    text: "Binecuvântează, suflete, pe Domnul și nu uita nici una din binefacerile Lui!",
    axis: "character",
  ...
  },
  {
    ...
    section: "cand_multumesti",
    ref: "Iacov 1:17",
    text: "Orice dar bun și orice dar desăvârșit este de sus, coborând de la Tatăl luminilor.",
    axis: "character",
  ...
  // când nu știi încotro
  {
    ...
    ref: "Proverbe 3:5-6",
    text: "Încrede-te în Domnul cu toată inima ta… și El îți va netezi căile.",
    axis: "living_faith",
  ...
  },
  {
    ...
    section: "cand_nu_stii_incotro",
    ref: "Psalmul 32:8",
    text: "Eu te voi învăța calea pe care trebuie s-o urmezi, te voi sfătui și te voi privi.",
    axis: "living_faith",
  ...
  },
  {
    ...
    section: "cand_nu_stii_incotro",
    ref: "Isaia 30:21",
    text: "Urechile tale vor auzi glasul care va zice: „Iată calea, mergeți pe ea!”",
    axis: "living_faith",
