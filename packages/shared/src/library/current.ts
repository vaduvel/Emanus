...
const open=(course:LibraryCourse):LibraryCourse=>liveCourses[course.id]?{...course,lessonIds:liveCourses[course.id],state:"live"}:course
...
export const LIBRARY_LESSONS:Lesson[]=[...base.LIBRARY_LESSONS,...DOCTRINE_BIBLIA_LESSONS,...DOCTRINE_BISERICA_LESSONS,...RUGACIUNE_INCEPUT_LESSONS,...SPIRITUAL_LUMEA_LESSONS,...SPIRITUAL_DISCERN_LESSONS,...SPIRITUAL_BLESTEM_LESSONS,...SPIRITUAL_LIBERTATE_LESSONS]
...
export const WRITING_ORDER=base.WRITING_ORDER.filter(id=>!["doctrine_c1_biblia","doctrine_c3_biserica","lib_rug_inceput"].includes(id))
