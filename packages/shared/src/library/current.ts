...
const liveCourses: Record<string, string[]> = {
  ...
  lib_rug_inceput: [
    "rug_inceput_l1", "rug_inceput_l2", "rug_inceput_l3", "rug_inceput_l4", "rug_inceput_l5",
    "rug_inceput_l6", "rug_inceput_l7", "rug_inceput_l8", "rug_inceput_l9",
  ],
  ...
  spiritual_c2_discernamant: [
    "spirit_discern_l1", "spirit_discern_l2", "spirit_discern_l3",
    "spirit_discern_l4", "spirit_discern_l5", "spirit_discern_l6",
  ],
}
...
const spiritualShelf: LibraryShelf = {
  ...
  courses: [
    {
      id: "spiritual_c1_lumea_nevazuta", title: "Lumea nevăzută: ce spune Biblia",
      forWhom: "Vrei să înțelegi ce sunt îngerii și demonii și de ce Iisus rămâne centrul.",
      plannedLessons: 6, lessonIds: liveCourses.spiritual_c1_lumea_nevazuta, state: "live",
      source: "Scriptura; docs/14-carta-doctrinara.md; cercetare Allen Nolan — Angels and Demons",
    },
    {
      id: "spiritual_c2_discernamant", title: "Discerne lupta",
      forWhom: "Nu știi dacă ceea ce trăiești vine din fire, lume, traumă, boală sau atac spiritual.",
      plannedLessons: 6, lessonIds: liveCourses.spiritual_c2_discernamant, state: "live",
      source: "Scriptura; docs/14-carta-doctrinara.md; surse interdisciplinare de îngrijire pastorală",
    },
    {
      id: "spiritual_c3_blessings", title: "Blesteme, legături și uși deschise",
      forWhom: "Te temi de trecut, de practici oculte sau de lucruri transmise în familie.",
      plannedLessons: 6, lessonIds: [], state: "planned",
    },
    {
      id: "spiritual_c4_libertate", title: "Libertate și autoritate în Hristos",
      forWhom: "Vrei să înțelegi pocăința, renunțarea, împotrivirea și rugăciunea pentru eliberare.",
      plannedLessons: 7, lessonIds: [], state: "planned",
    },
  ],
}
