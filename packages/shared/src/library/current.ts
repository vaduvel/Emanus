...
const live:Record<string,string[]>={
 ...
 identitate_c1_chip:ids("identitate_vocatie_l",6),identitate_c2_caracter:ids("caracter_hristos_l",7),barbati_c1_formare:ids("barbat_formare_l",7),barbati_c2_lupta:ids("barbat_lupta_l",7),barbati_c3_relatii:ids("barbat_relatii_l",6),barbati_c4_sot:ids("sot_hristos_l",7),femei_c1_formare:ids("femeie_formare_l",7),femei_c2_lupta:ids("femeie_lupta_l",7),femei_c3_relatii:ids("femeie_relatii_l",6),femei_c4_sotie:ids("sotie_legamant_l",7),
...
export const WRITING_ORDER=["barbati_c5_tata","femei_c5_mama",...base.WRITING_ORDER].filter((id,i,a)=>!done.has(id)&&a.indexOf(id)===i)
