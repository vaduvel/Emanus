...
const live:Record<string,string[]>={
 ...
 identitate_c1_chip:ids("identitate_vocatie_l",6),identitate_c2_caracter:ids("caracter_hristos_l",7),barbati_c1_formare:ids("barbat_formare_l",7),femei_c1_formare:ids("femeie_formare_l",7),
...
const men=shelf("lib_barbati","Viața de bărbat","Bărbat format după chipul lui Hristos, nu după guru sau stereotipuri.",[
 course("barbati_c1_formare","Bărbat după chipul lui Hristos",7,"live"),course("barbati_c2_lupta","Lupta din interiorul bărbatului",7),course("barbati_c3_relatii","Bărbatul în relații",6),course("barbati_c4_sot","Soț care iubește asemenea lui Hristos",7),course("barbati_c5_tata","Tată prezent",6)])
const women=shelf("lib_femei","Viața de femeie","Femeie formată de Scriptură, nu redusă la imagine, rol sau social media.",[
 course("femei_c1_formare","Femeie după inima lui Dumnezeu",7,"live"),course("femei_c2_lupta","Lupta din interiorul femeii",7),course("femei_c3_relatii","Femeia în relații",6),course("femei_c4_sotie","Soție, parteneră de legământ",7),course("femei_c5_mama","Mamă fără să se piardă pe sine",6)])
...
export const WRITING_ORDER=["barbati_c2_lupta","femei_c2_lupta","barbati_c3_relatii","femei_c3_relatii","barbati_c4_sot","femei_c4_sotie","barbati_c5_tata","femei_c5_mama",...base.WRITING_ORDER].filter((id,i,a)=>!done.has(id)&&a.indexOf(id)===i)
