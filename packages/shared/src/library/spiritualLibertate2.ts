...
const lesson=(id:string,order:number,title:string,ref:string,verse:string,hook:string,truth:string,step:string,prayer:string,prompt:string,choices:[string,string,string]):Lesson=>({id,courseId:"spiritual_c4_libertate",order,title,estMinutes:14,anchorRefs:[ref],memoryVerseRef:ref,steps:[
{id:`${id}_1`,type:"hook",order:1,bubbles:[{from:"guide",text:hook}]},
{id:`${id}_2`,type:"scripture",order:2,scripture:{text:verse,ref}},
{id:`${id}_3`,type:"truth_simple",order:3,bubbles:[{from:"guide",text:truth}]},
{id:`${id}_4`,type:"choice",order:4,choice:{prompt,options:choices.map((label,index)=>({id:`${id}${index+1}`,label}))}},
...
export const libertateL4=lesson("spirit_libertate_l4",4,"Supune-te și împotrivește-te","Iacov 4:7","Supuneți-vă lui Dumnezeu. Împotriviți-vă diavolului, și el va fugi de la voi.","Uneori împotrivirea este prezentată ca o probă de curaj sau volum. Iacov o așază după o alegere mai adâncă: supunerea față de Dumnezeu.","Ordinea contează: întâi supunere lui Dumnezeu, apoi împotrivire. Nu volumul, formula sau temperamentul dau autoritate, ci Iisus și adevărul Lui.","Numește minciuna, răspunde cu adevărul Scripturii, închide accesul practic și cere sprijin. Dacă există manifestări severe, nu confrunta singur.","«Mă supun lui Dumnezeu și refuz minciuna ___. Iisuse, păzește-mă și întărește-mă să rămân în adevăr.»","Unde începe pentru tine supunerea față de Dumnezeu?",["Să mă supun lui Dumnezeu înaintea confruntării.","Să răspund minciunii cu adevărul Scripturii.","Să cer sprijin pentru manifestări severe."])

export const libertateL5=lesson("spirit_libertate_l5",5,"Armura lui Dumnezeu","Efeseni 6:11","Îmbrăcați-vă cu toată armura lui Dumnezeu, ca să puteți ține piept împotriva uneltirilor diavolului.","Imaginea armurii poate deveni decor religios dacă nu ajunge în felul concret în care spui adevărul, cauți pacea și rămâi treaz.","Armura nu este costum imaginar activat prin incantație. Este viața în adevăr, dreptate, Evanghelia păcii, credință, mântuire, Cuvânt și rugăciune.","Alege piesa neglijată și transform-o în ascultare: spune adevărul, repară nedreptatea, caută pacea, ridică credința sau răspunde cu Scriptura.","«Doamne, așază-mă în adevărul, dreptatea, pacea, credința, mântuirea și Cuvântul Tău. Fă-mă treaz și statornic.»","Ce parte a armurii trebuie să devină ascultare concretă?",["Să aleg piesa armurii pe care am neglijat-o.","Să o transform într-un act de ascultare.","Să rămân treaz în rugăciune și comunitate."])
