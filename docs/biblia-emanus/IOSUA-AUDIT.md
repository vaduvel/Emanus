# Registru editorial — Iosua

Acest document păstrează deciziile transversale folosite la auditarea traducerii Biblia Emanus pentru cartea Iosua.
...
- VDC 1924, NTR și BTF2015 sunt consultate numai `comparison-only`;
...
- `herem`: „dat spre nimicire” sau „lucru dat spre nimicire”, după context;
- `aron berit YHWH`: „chivotul legământului DOMNULUI”;
...
- Iosua 5:1 — ketiv „noi am trecut” și qere „ei au trecut”;
- Iosua 8:13 — „în mijlocul văii” și lectura alternativă legată de popor;
...
- promisiunile făcute lui Iosua în misiunea sa nu sunt transformate în garanții universale pentru orice proiect personal;
