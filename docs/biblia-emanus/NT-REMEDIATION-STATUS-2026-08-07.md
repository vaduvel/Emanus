...
punct au fost revizuite și documentate 821 din cele 7.941 de versete BE
(10,34%), în patruzeci și două de loturi. Aceste jurnale de lucru nu sunt registrul final
per-verset și nu constituie aprobare de publicare.

## Baza verificării

- Comparație: `origin/main` la `2260149cd078d4442a1111e33e74d02567bb6a45`
  față de baza de handoff `bb953506016397d47876e8a32c430d7e3cf87d9e`.
...
| `2TI.2` | 26 | `NT-AI-REVIEW-BATCH-2026-08-07-2TI.2.md` |
| `2TI.3` | 17 | `NT-AI-REVIEW-BATCH-2026-08-07-2TI.3.md` |
| `2TI.4` | 22 | `NT-AI-REVIEW-BATCH-2026-08-07-2TI.4.md` |
| `1JN.1` | 10 | `NT-AI-REVIEW-BATCH-2026-08-07-1JN.1.md` |
| `1JN.2` | 29 | `NT-AI-REVIEW-BATCH-2026-08-07-1JN.2.md` |
| `1JN.3` | 24 | `NT-AI-REVIEW-BATCH-2026-08-07-1JN.3.md` |
| `1JN.4` | 21 | `NT-AI-REVIEW-BATCH-2026-08-07-1JN.4.md` |
| `1JN.5` | 21 | `NT-AI-REVIEW-BATCH-2026-08-07-1JN.5.md` |
| `COL.1` | 29 | `NT-AI-REVIEW-BATCH-2026-08-07-COL.1.md` |
| `COL.2` | 23 | `NT-AI-REVIEW-BATCH-2026-08-07-COL.2.md` |
| `COL.3` | 25 | `NT-AI-REVIEW-BATCH-2026-08-07-COL.3.md` |
| `COL.4` | 18 | `NT-AI-REVIEW-BATCH-2026-08-07-COL.4.md` |
| **Total** | **821** | **10,34% din NT** |
...
În aceste patruzeci și două de loturi, NTR nu a fost consultată; câmpurile
...
cele patruzeci și două de loturi documentate nu substituie revizia completă.
