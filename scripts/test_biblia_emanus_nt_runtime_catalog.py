...
class BibliaEmanusNtRuntimeCatalogTests(unittest.TestCase):
    ...
    def test_canonical_gate_currently_blocks_any_runtime_promotion(self) -> None:
        ...
        with patch.object(catalog, "validate_materialized_nt_corpus") as materialization:
            with self.assertRaisesRegex(catalog.RuntimeCatalogError, "registrul de aprobare per-verset"):
