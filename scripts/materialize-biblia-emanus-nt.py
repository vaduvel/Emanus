...
def render_typescript(payload: dict[str, dict[str, dict[str, Any]]]) -> str:
    ...
    return (
        ...
        "export type BibliaEmanusNoteKind = \"absent-from-critical-main-text\" | \"textual-variant\"\n"
        "export interface BibliaEmanusTextNote {\n"
        "  verse: number\n"
        "  kind: BibliaEmanusNoteKind\n"
        "  note: string\n"
        "  reason?: string\n"
        ...
        "  notes: readonly BibliaEmanusTextNote[]\n"
        "  alternateEndings: readonly Readonly<Record<string, unknown>>[]\n"
        "}\n"
        "export const BIBLIA_EMANUS_TRANSLATION = \"Biblia Emanus (BE)\"\n"
        "export const BIBLIA_EMANUS_NT_TEXT: Readonly<Record<string, Readonly<Record<string, BibliaEmanusChapterText>>>> = "
        + body
        + "\n"
    )
