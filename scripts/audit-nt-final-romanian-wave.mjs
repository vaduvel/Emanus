...
const report = {
  schema: "emanus-nt-final-romanian-wave-audit-v1",
...
console.log(`NT final Romanian wave audit: ${findings.length} unresolved occurrences across ${REPLACEMENTS.size} safe classes.`)
if (findings.length) {
