...
function fail(message) {
  console.error(`[NT lexicon editorial fixes] ${message}`)
  process.exit(1)
}
...
console.log(`NT lexicon editorial fixes: ${applied}/${FIXES.length} targeted meanings separated from passage application.`)
