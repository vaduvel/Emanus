...
const FIXES = [
  ...
  { bookId: "marcu", canonicalBookId: "MRK", chapter: 8, field: "units[3].teaching", before: "Dar voi cine spuneți că sunt?", after: "Dar voi cine ziceți că sunt eu?" },
  { bookId: "marcu", canonicalBookId: "MRK", chapter: 13, field: "units[0].teaching", before: "Să nu vă înșele cineva.", after: "Aveți grijă să nu vă rătăcească cineva!" },
  { bookId: "marcu", canonicalBookId: "MRK", chapter: 14, field: "units[0].teaching", before: "Ea a făcut ce a putut.", after: "Ea a făcut ce i-a stat în putere" },
