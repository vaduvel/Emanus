...
for (const [id, blueprint] of Object.entries(NT_SOURCE_FIRST_BLUEPRINTS)) {
  ...
  const override = NT_SOURCE_FIRST_WAVE_C_OVERRIDES[id] ?? NT_SOURCE_FIRST_WAVE_B_OVERRIDES[id] ?? NT_SOURCE_FIRST_WAVE_A_OVERRIDES[id] ?? NT_SOURCE_FIRST_PASSAGE_OVERRIDES[id]
